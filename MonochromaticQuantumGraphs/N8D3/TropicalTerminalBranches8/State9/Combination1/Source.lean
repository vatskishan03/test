import MonochromaticQuantumGraphs.N8D3.TropicalTerminalBranches8.State9.Combination1.Data

/-! Sparse source equality for `terminalBState9Combination1`. -/
...
theorem terminalBState9Combination1SourceExplicit8 :
    LaurentPolynomial.translate terminalBState9CombinationShift1_8 (tropicalComponentBQuotientRelation8 0) - tropicalComponentBQuotientRelation8 2 = (Finsupp.single (Pi.single (15 : Fin 144) (1 : ℤ) +
  ...
  have hShiftedExponent0 :
      terminalBState9CombinationShift1_8 + (Pi.single (15 : Fin 144) (1 : ℤ) +
        Pi.single (39 : Fin 144) (1 : ℤ) +
        Pi.single (88 : Fin 144) (1 : ℤ) +
  ...
  have hShiftedExponent2 :
      terminalBState9CombinationShift1_8 + (Pi.single (6 : Fin 144) (1 : ℤ) +
        Pi.single (59 : Fin 144) (1 : ℤ) +
        Pi.single (69 : Fin 144) (-1 : ℤ) +
        Pi.single (70 : Fin 144) (1 : ℤ) +
        Pi.single (98 : Fin 144) (1 : ℤ) +
...
theorem terminalBState9Combination1SourceEq8 :
    (∑ k : Fin 8,
      Finsupp.single (terminalBState9Combination1ReductionUse8 k).sourceExponent
        (terminalBState9Combination1ReductionUse8 k).coefficient) = LaurentPolynomial.translate terminalBState9CombinationShift1_8 (tropicalComponentBQuotientRelation8 0) - tropicalComponentBQuotientRelation8 2 := by
  rw [terminalBState9Combination1SourceExplicit8]
  simp only [Fin.sum_univ_succ, terminalBState9Combination1ReductionUse8] <;> abel
