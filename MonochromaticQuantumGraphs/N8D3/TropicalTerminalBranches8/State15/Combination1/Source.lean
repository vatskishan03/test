import MonochromaticQuantumGraphs.N8D3.TropicalTerminalBranches8.State15.Combination1.Data

/-! Sparse source equality for `terminalBState15Combination1`. -/
...
theorem terminalBState15Combination1SourceExplicit8 :
    LaurentPolynomial.translate terminalBState15CombinationShift1_8 (tropicalComponentBQuotientRelation8 0) - tropicalComponentBQuotientRelation8 2 = (Finsupp.single (Pi.single (15 : Fin 144) (1 : ℤ) +
  ...
  have hShiftedExponent0 :
      terminalBState15CombinationShift1_8 + (Pi.single (15 : Fin 144) (1 : ℤ) +
        Pi.single (39 : Fin 144) (1 : ℤ) +
        Pi.single (88 : Fin 144) (1 : ℤ) +
  ...
  have hShiftedExponent2 :
      terminalBState15CombinationShift1_8 + (Pi.single (6 : Fin 144) (1 : ℤ) +
        Pi.single (59 : Fin 144) (1 : ℤ) +
        Pi.single (69 : Fin 144) (-1 : ℤ) +
        Pi.single (70 : Fin 144) (1 : ℤ) +
        Pi.single (98 : Fin 144) (1 : ℤ) +
...
theorem terminalBState15Combination1SourceEq8 :
    (∑ k : Fin 8,
      Finsupp.single (terminalBState15Combination1ReductionUse8 k).sourceExponent
        (terminalBState15Combination1ReductionUse8 k).coefficient) = LaurentPolynomial.translate terminalBState15CombinationShift1_8 (tropicalComponentBQuotientRelation8 0) - tropicalComponentBQuotientRelation8 2 := by
  rw [terminalBState15Combination1SourceExplicit8]
  simp only [Fin.sum_univ_succ, terminalBState15Combination1ReductionUse8] <;> abel
