import MonochromaticQuantumGraphs.N8D3.TropicalTerminalBranches8.State3.Combination0.Data

/-! Sparse source equality for `terminalBState3Combination0`. -/
...
theorem terminalBState3Combination0SourceExplicit8 :
    LaurentPolynomial.translate terminalBState3CombinationShift0_8 (tropicalComponentBQuotientRelation8 0) - tropicalComponentBQuotientRelation8 2 = (Finsupp.single (Pi.single (9 : Fin 144) (-1 : ℤ) +
  ...
  have hShiftedExponent0 :
      terminalBState3CombinationShift0_8 + (Pi.single (15 : Fin 144) (1 : ℤ) +
        Pi.single (39 : Fin 144) (1 : ℤ) +
        Pi.single (88 : Fin 144) (1 : ℤ) +
  ...
  have hShiftedExponent2 :
      terminalBState3CombinationShift0_8 + (Pi.single (6 : Fin 144) (1 : ℤ) +
        Pi.single (59 : Fin 144) (1 : ℤ) +
        Pi.single (69 : Fin 144) (-1 : ℤ) +
        Pi.single (70 : Fin 144) (1 : ℤ) +
        Pi.single (98 : Fin 144) (1 : ℤ) +
...
theorem terminalBState3Combination0SourceEq8 :
    (∑ k : Fin 8,
      Finsupp.single (terminalBState3Combination0ReductionUse8 k).sourceExponent
        (terminalBState3Combination0ReductionUse8 k).coefficient) = LaurentPolynomial.translate terminalBState3CombinationShift0_8 (tropicalComponentBQuotientRelation8 0) - tropicalComponentBQuotientRelation8 2 := by
  rw [terminalBState3Combination0SourceExplicit8]
  simp only [Fin.sum_univ_succ, terminalBState3Combination0ReductionUse8] <;> abel
