...
/-! Bounded 1213/874 shifted exponent 0 -/
...
@[simp] theorem terminalA1213_874TranslatedRightExponent8_term000 :
    (Pi.single 139 (1 : ℤ) + Pi.single 142 ((-1) : ℤ)) + (Pi.single 3 (1 : ℤ) + Pi.single 57 (1 : ℤ) + Pi.single 98 (1 : ℤ) + Pi.single 142 (1 : ℤ)) =
