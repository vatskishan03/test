...
/-! Bounded 437/65 shifted exponent 2 -/
...
@[simp] theorem terminalA437_65TranslatedRightExponent8_term002 :
    (Pi.single 138 (1 : ℤ) + Pi.single 141 ((-1) : ℤ)) + (Pi.single 4 (1 : ℤ) + Pi.single 69 (1 : ℤ) + Pi.single 82 (1 : ℤ) + Pi.single 141 (1 : ℤ)) =
