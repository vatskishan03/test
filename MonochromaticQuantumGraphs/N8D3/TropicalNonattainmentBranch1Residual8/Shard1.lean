...
/-! # Branch-one residual expansion shard 1 -/
...
theorem branch1ResidualGroupedExpansion8_shard1
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W) :
    branch1X8 W * pmSumN 8 3 W (branch1ResidualBaseColoring8 1) -
        branch1Y8 W * pmSumN 8 3 W (branch1ResidualChangedColoring8 1) =
      branch1ResidualGroupedRhs8 W 1 := by
  rw [pmSumN8_eq_sum_tropicalSupportedTerms8 hSupport,
    branch1ResidualBaseSupportedSet8 1,
    pmSumN8_eq_sum_tropicalSupportedTerms8 hSupport,
    branch1ResidualChangedSupportedSet8 1]
