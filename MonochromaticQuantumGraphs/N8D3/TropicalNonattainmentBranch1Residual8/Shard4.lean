...
/-! # Branch-one residual expansion shard 4 -/
...
theorem branch1ResidualGroupedExpansion8_shard4
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W) :
    branch1X8 W * pmSumN 8 3 W (branch1ResidualBaseColoring8 4) -
        branch1Y8 W * pmSumN 8 3 W (branch1ResidualChangedColoring8 4) =
      branch1ResidualGroupedRhs8 W 4 := by
  rw [pmSumN8_eq_sum_tropicalSupportedTerms8 hSupport,
    branch1ResidualBaseSupportedSet8 4,
    pmSumN8_eq_sum_tropicalSupportedTerms8 hSupport,
    branch1ResidualChangedSupportedSet8 4]
  simp [branch1ResidualMatchingSet8, branch1ResidualMatchingSet12_8,
