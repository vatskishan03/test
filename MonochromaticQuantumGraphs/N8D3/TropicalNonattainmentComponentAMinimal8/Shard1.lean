...
/-- Minimality replay for recovered Component A rows 9 through 17. -/
theorem componentACover8_minimal_shard1 (i : Fin 9) :
    IsMinimalVertexCover componentAFactorEdge8
      (componentACover8 (componentAMinimalIndex8 1 i)) := by
  revert i
