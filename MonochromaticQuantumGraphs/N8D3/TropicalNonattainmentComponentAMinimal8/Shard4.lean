...
/-- Minimality replay for recovered Component A rows 36 through 44. -/
theorem componentACover8_minimal_shard4 (i : Fin 9) :
    IsMinimalVertexCover componentAFactorEdge8
      (componentACover8 (componentAMinimalIndex8 4 i)) := by
  revert i
