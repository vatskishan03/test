...
/-!
# Component-A source reduction 88: row-local semantic hold
-/
...
theorem hold
  ...
  have hi := tropicalBaseRelations8_hold hSupport hEq
    tropicalOverlapProvenance8Row246.sourceI
  have hj := tropicalBaseRelations8_hold hSupport hEq
    tropicalOverlapProvenance8Row246.sourceJ
  have hsource : sourcePolynomial.Holds (tropicalSupportWeight8 W) := by
    rw [sourcePolynomial, tropicalOverlapRelation8_provenance_row246]
  ...
  exact holds_of_normalizedCharacterReductionCertificate
    ...
    tropicalComponentASourceReductionCertificate8_088 hChars hsource

end TropicalFactorA8.Internal.Source088

/-- Public source-hold API for row 88. -/
theorem tropicalComponentASourceReduced8_088_hold
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W)
    (hEq : EqSystemN 8 3 W) (hChars : TropicalComponentACharacters8 W) :
    TropicalFactorA8.Internal.Source088.reduced.Holds
