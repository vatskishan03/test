...
/-!
# Component-A source reduction 12: row-local semantic hold
-/
...
theorem hold
  ...
  have hi := tropicalBaseRelations8_hold hSupport hEq
    tropicalOverlapProvenance8Row18.sourceI
  have hj := tropicalBaseRelations8_hold hSupport hEq
    tropicalOverlapProvenance8Row18.sourceJ
  have hsource : sourcePolynomial.Holds (tropicalSupportWeight8 W) := by
    rw [sourcePolynomial, tropicalOverlapRelation8_provenance_row18]
  ...
  exact holds_of_normalizedCharacterReductionCertificate
    ...
    tropicalComponentASourceReductionCertificate8_012 hChars hsource

end TropicalFactorA8.Internal.Source012

/-- Public source-hold API for row 12. -/
theorem tropicalComponentASourceReduced8_012_hold
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W)
    (hEq : EqSystemN 8 3 W) (hChars : TropicalComponentACharacters8 W) :
    TropicalFactorA8.Internal.Source012.reduced.Holds
