...
/-!
# Component-A source reduction 0: row-local semantic hold
-/
...
theorem hold
  ...
  exact holds_of_normalizedCharacterReductionCertificate
    ...
    tropicalComponentASourceReductionCertificate8_000 hChars hsource

end TropicalFactorA8.Internal.Source000

/-- Public source-hold API for row 0. -/
theorem tropicalComponentASourceReduced8_000_hold
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W)
    (hEq : EqSystemN 8 3 W) (hChars : TropicalComponentACharacters8 W) :
    TropicalFactorA8.Internal.Source000.reduced.Holds
