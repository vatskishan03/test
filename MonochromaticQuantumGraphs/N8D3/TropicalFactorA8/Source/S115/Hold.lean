...
/-!
# Component-A source reduction 115: row-local semantic hold
-/
...
theorem hold
  ...
  have hi := tropicalBaseRelations8_hold hSupport hEq
    tropicalOverlapProvenance8Row306.sourceI
  have hj := tropicalBaseRelations8_hold hSupport hEq
    tropicalOverlapProvenance8Row306.sourceJ
  have hsource : sourcePolynomial.Holds (tropicalSupportWeight8 W) := by
    rw [sourcePolynomial, tropicalOverlapRelation8_provenance_row306]
  ...
  exact holds_of_normalizedCharacterReductionCertificate
    ...
    tropicalComponentASourceReductionCertificate8_115 hChars hsource

end TropicalFactorA8.Internal.Source115

/-- Public source-hold API for row 115. -/
theorem tropicalComponentASourceReduced8_115_hold
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W)
    (hEq : EqSystemN 8 3 W) (hChars : TropicalComponentACharacters8 W) :
    TropicalFactorA8.Internal.Source115.reduced.Holds
      (tropicalSupportWeight8 W) :=
  TropicalFactorA8.Internal.Source115.hold hSupport hEq hChars
