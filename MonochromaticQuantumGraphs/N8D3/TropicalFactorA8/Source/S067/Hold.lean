...
/-!
# Component-A source reduction 67: row-local semantic hold
-/
...
theorem hold
  ...
  exact holds_of_normalizedCharacterReductionCertificate
    ...
    tropicalComponentASourceReductionCertificate8_067 hChars hsource

end TropicalFactorA8.Internal.Source067

/-- Public source-hold API for row 67. -/
theorem tropicalComponentASourceReduced8_067_hold
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W)
    (hEq : EqSystemN 8 3 W) (hChars : TropicalComponentACharacters8 W) :
    TropicalFactorA8.Internal.Source067.reduced.Holds
