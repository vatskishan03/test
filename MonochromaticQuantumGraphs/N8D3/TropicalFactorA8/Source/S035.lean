...
/-!
# Component-A normalized source reduction 35
...
private def tropicalComponentASourceReduction035Monomial008 :
...
private def tropicalComponentASourceReduction035Monomial018 :
    MonomialReductionCertificate tropicalComponentACharacter8
      (Pi.single (1 : Fin 144) (1 : ℤ) +
        Pi.single (64 : Fin 144) (1 : ℤ) +
        Pi.single (86 : Fin 144) (1 : ℤ) +
...
private def tropicalComponentASourceReduction035Monomial028 :
    MonomialReductionCertificate tropicalComponentACharacter8
      (Pi.single (1 : Fin 144) (1 : ℤ) +
        Pi.single (64 : Fin 144) (1 : ℤ) +
...
private def tropicalComponentASourceReduction035Monomial038 :
    MonomialReductionCertificate tropicalComponentACharacter8
      (Pi.single (1 : Fin 144) (1 : ℤ) +
        Pi.single (64 : Fin 144) (1 : ℤ) +
        Pi.single (87 : Fin 144) (1 : ℤ) +
...
private def tropicalComponentASourceReduction035Monomial048 :
    MonomialReductionCertificate tropicalComponentACharacter8
...
private def tropicalComponentASourceReduction035Monomial058 :
    MonomialReductionCertificate tropicalComponentACharacter8
      (Pi.single (19 : Fin 144) (1 : ℤ) +
        Pi.single (51 : Fin 144) (1 : ℤ) +
        Pi.single (76 : Fin 144) (1 : ℤ) +
...
private def tropicalComponentASourceReduction035Use8 :
...
![
  { coefficient := (1 : ℤ)
      ...
      targetExponent := (Pi.single (1 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (105 : Fin 144) (1 : ℤ) +
        Pi.single (138 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentASourceReduction035Monomial008 },
  { coefficient := (1 : ℤ)
      sourceExponent := (Pi.single (1 : Fin 144) (1 : ℤ) +
        Pi.single (64 : Fin 144) (1 : ℤ) +
        Pi.single (86 : Fin 144) (1 : ℤ) +
      ...
      targetExponent := (Pi.single (1 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (114 : Fin 144) (1 : ℤ) +
        Pi.single (129 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentASourceReduction035Monomial018 },
  { coefficient := (-1 : ℤ)
      sourceExponent := (Pi.single (1 : Fin 144) (1 : ℤ) +
        Pi.single (64 : Fin 144) (1 : ℤ) +
        Pi.single (87 : Fin 144) (1 : ℤ) +
      ...
      targetExponent := (Pi.single (1 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (102 : Fin 144) (1 : ℤ) +
        Pi.single (138 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentASourceReduction035Monomial028 },
  { coefficient := (-1 : ℤ)
      sourceExponent := (Pi.single (1 : Fin 144) (1 : ℤ) +
        Pi.single (64 : Fin 144) (1 : ℤ) +
        Pi.single (87 : Fin 144) (1 : ℤ) +
      ...
      targetExponent := (Pi.single (1 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (111 : Fin 144) (1 : ℤ) +
        Pi.single (129 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentASourceReduction035Monomial038 },
  { coefficient := (1 : ℤ)
      ...
      targetExponent := (Pi.single (19 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (86 : Fin 144) (1 : ℤ) +
        Pi.single (122 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentASourceReduction035Monomial048 },
  { coefficient := (-1 : ℤ)
      sourceExponent := (Pi.single (19 : Fin 144) (1 : ℤ) +
        Pi.single (51 : Fin 144) (1 : ℤ) +
        Pi.single (76 : Fin 144) (1 : ℤ) +
      ...
      targetExponent := (Pi.single (19 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (87 : Fin 144) (1 : ℤ) +
        Pi.single (119 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentASourceReduction035Monomial058 }
]

private theorem tropicalComponentASourceReduction035_source_eq :
    (∑ k : Fin 6,
      Finsupp.single (tropicalComponentASourceReduction035Use8 k).sourceExponent
        (tropicalComponentASourceReduction035Use8 k).coefficient) = tropicalRetainedRelation8 (tropicalComponentAQuotientSourceIndex8 35) := by
  decide

private theorem tropicalComponentASourceReduction035_target_eq :
    (∑ k : Fin 6,
      Finsupp.single (tropicalComponentASourceReduction035Use8 k).targetExponent
        (signedCoefficient (tropicalComponentASourceReduction035Use8 k).reduction.signExponent
          (tropicalComponentASourceReduction035Use8 k).coefficient)) =
...
def tropicalComponentASourceReductionCertificate8_035 :
  ...
  reduction := {
    use := tropicalComponentASourceReduction035Use8
    source_eq := tropicalComponentASourceReduction035_source_eq
    target_eq := tropicalComponentASourceReduction035_target_eq
  }
