...
/-!
# Component-A source reduction 4: row-local semantic hold
-/
...
theorem hold
  ...
  exact holds_of_normalizedCharacterReductionCertificate
    ...
    tropicalComponentASourceReductionCertificate8_004 hChars hsource

end TropicalFactorA8.Internal.Source004

/-- Public source-hold API for row 4. -/
theorem tropicalComponentASourceReduced8_004_hold
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W)
    (hEq : EqSystemN 8 3 W) (hChars : TropicalComponentACharacters8 W) :
    TropicalFactorA8.Internal.Source004.reduced.Holds
