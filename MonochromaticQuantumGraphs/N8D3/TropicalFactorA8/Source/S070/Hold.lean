...
/-!
# Component-A source reduction 70: row-local semantic hold
-/
...
theorem hold
  ...
  exact holds_of_normalizedCharacterReductionCertificate
    ...
    tropicalComponentASourceReductionCertificate8_070 hChars hsource

end TropicalFactorA8.Internal.Source070

/-- Public source-hold API for row 70. -/
theorem tropicalComponentASourceReduced8_070_hold
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W)
    (hEq : EqSystemN 8 3 W) (hChars : TropicalComponentACharacters8 W) :
    TropicalFactorA8.Internal.Source070.reduced.Holds
