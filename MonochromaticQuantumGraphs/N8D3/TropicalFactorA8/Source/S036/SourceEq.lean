...
/-!
# Component-A source reduction 36: original polynomial equality
-/
...
theorem source_eq :
    (∑ k : Fin 6,
      ...
      sourcePolynomial := by
  simp [use, monomial00, monomial01, monomial02, monomial03, monomial04, monomial05, sourcePolynomial, tropicalOverlapRelation8Row92,
