...
/-!
# Component-A source reduction 47: row-local semantic hold
-/
...
theorem hold
  ...
  have hi := tropicalBaseRelations8_hold hSupport hEq
    tropicalOverlapProvenance8Row166.sourceI
  have hj := tropicalBaseRelations8_hold hSupport hEq
    tropicalOverlapProvenance8Row166.sourceJ
  have hsource : sourcePolynomial.Holds (tropicalSupportWeight8 W) := by
    rw [sourcePolynomial, tropicalOverlapRelation8_provenance_row166]
  ...
  exact holds_of_normalizedCharacterReductionCertificate
    ...
    tropicalComponentASourceReductionCertificate8_047 hChars hsource

end TropicalFactorA8.Internal.Source047

/-- Public source-hold API for row 47. -/
theorem tropicalComponentASourceReduced8_047_hold
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W)
    (hEq : EqSystemN 8 3 W) (hChars : TropicalComponentACharacters8 W) :
    TropicalFactorA8.Internal.Source047.reduced.Holds
      (tropicalSupportWeight8 W) :=
  TropicalFactorA8.Internal.Source047.hold hSupport hEq hChars
