...
/-!
# Component-A source reduction 55: row-local semantic hold
-/
...
theorem hold
  ...
  exact holds_of_normalizedCharacterReductionCertificate
    ...
    tropicalComponentASourceReductionCertificate8_055 hChars hsource

end TropicalFactorA8.Internal.Source055

/-- Public source-hold API for row 55. -/
theorem tropicalComponentASourceReduced8_055_hold
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W)
    (hEq : EqSystemN 8 3 W) (hChars : TropicalComponentACharacters8 W) :
    TropicalFactorA8.Internal.Source055.reduced.Holds
