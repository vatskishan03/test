...
/-!
# Component-A source reduction 18: row-local semantic hold
-/
...
theorem hold
  ...
  exact holds_of_normalizedCharacterReductionCertificate
    ...
    tropicalComponentASourceReductionCertificate8_018 hChars hsource

end TropicalFactorA8.Internal.Source018

/-- Public source-hold API for row 18. -/
theorem tropicalComponentASourceReduced8_018_hold
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W)
    (hEq : EqSystemN 8 3 W) (hChars : TropicalComponentACharacters8 W) :
    TropicalFactorA8.Internal.Source018.reduced.Holds
