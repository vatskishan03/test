...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.Vertex.V024

/-!
# Row-local data for Component-A factor edge 18
-/
...
def sourceRelation : LaurentPolynomial (Fin 144) :=
  TropicalFactorA8.Internal.Quotient064.relation
