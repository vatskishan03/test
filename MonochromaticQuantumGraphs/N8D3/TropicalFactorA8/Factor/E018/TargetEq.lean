import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.E018.Uses

/-!
# Component-A factor edge 18: translated product equality
-/
    ...
    (∑ k : Fin 4,
      ...
      (1 : ℤ) • LaurentPolynomial.translate shift
        ((tropicalComponentARawFactor8 2).factorProductPolynomial
          (tropicalComponentARawFactor8 24)) := by
