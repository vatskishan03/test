...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.Vertex.V054

/-!
# Row-local data for Component-A factor edge 4
-/
...
def sourceRelation : LaurentPolynomial (Fin 144) :=
  TropicalFactorA8.Internal.Quotient051.relation
