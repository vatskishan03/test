import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.E004.Uses

/-!
# Component-A factor edge 4: translated product equality
-/
...
theorem target_eq :
    (∑ k : Fin 4,
      ...
      (1 : ℤ) • LaurentPolynomial.translate shift
        ((tropicalComponentARawFactor8 0).factorProductPolynomial
          (tropicalComponentARawFactor8 54)) := by
  have h00 : shift + ((Pi.single (89 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (75 : Fin 144) (1 : ℤ))) = (Pi.single (20 : Fin 144) (1 : ℤ) +
        Pi.single (51 : Fin 144) (1 : ℤ) +
  ...
  have h02 : shift + (Pi.single (0 : Fin 144) (1 : ℤ) +
    ...
    unfold shift
    abel
  have h03 : shift + (0 : LaurentExponent (Fin 144)) = (Pi.single (0 : Fin 144) (-1 : ℤ) +
        Pi.single (1 : Fin 144) (1 : ℤ) +
        Pi.single (20 : Fin 144) (1 : ℤ) +
        Pi.single (48 : Fin 144) (1 : ℤ) +
        Pi.single (59 : Fin 144) (-1 : ℤ) +
