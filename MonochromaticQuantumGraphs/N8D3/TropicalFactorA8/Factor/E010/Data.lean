...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.Vertex.V023

/-!
# Row-local data for Component-A factor edge 10
-/
...
def sourceRelation : LaurentPolynomial (Fin 144) :=
  TropicalFactorA8.Internal.Quotient053.relation
