...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.Vertex.V051

/-!
# Row-local data for Component-A factor edge 58
-/
...
def sourceRelation : LaurentPolynomial (Fin 144) :=
  TropicalFactorA8.Internal.Quotient020.relation
