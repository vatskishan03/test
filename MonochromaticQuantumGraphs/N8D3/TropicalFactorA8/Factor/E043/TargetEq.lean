import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.E043.Uses

/-!
# Component-A factor edge 43: translated product equality
-/
...
theorem target_eq :
    (∑ k : Fin 4,
      ...
      (1 : ℤ) • LaurentPolynomial.translate shift
        ((tropicalComponentARawFactor8 16).factorProductPolynomial
          (tropicalComponentARawFactor8 36)) := by
  have h00 : shift + ((Pi.single (64 : Fin 144) (1 : ℤ) +
        Pi.single (65 : Fin 144) (-1 : ℤ) +
        Pi.single (85 : Fin 144) (-1 : ℤ) +
        Pi.single (89 : Fin 144) (1 : ℤ) +
        Pi.single (99 : Fin 144) (1 : ℤ) +
        Pi.single (102 : Fin 144) (-1 : ℤ)) + (Pi.single (48 : Fin 144) (1 : ℤ) +
    ...
    unfold shift
    abel
  have h01 : shift + (Pi.single (64 : Fin 144) (1 : ℤ) +
        Pi.single (65 : Fin 144) (-1 : ℤ) +
        Pi.single (85 : Fin 144) (-1 : ℤ) +
        Pi.single (89 : Fin 144) (1 : ℤ) +
        Pi.single (99 : Fin 144) (1 : ℤ) +
        Pi.single (102 : Fin 144) (-1 : ℤ)) = (Pi.single (7 : Fin 144) (1 : ℤ) +
