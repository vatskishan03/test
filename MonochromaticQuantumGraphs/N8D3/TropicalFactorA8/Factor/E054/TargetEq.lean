import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.E054.Uses

/-!
# Component-A factor edge 54: translated product equality
-/
...
theorem target_eq :
    (∑ k : Fin 4,
      ...
      (1 : ℤ) • LaurentPolynomial.translate shift
        ((tropicalComponentARawFactor8 30).factorProductPolynomial
