import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.E023.Uses

/-!
# Component-A factor edge 23: translated product equality
-/
...
theorem target_eq :
    (∑ k : Fin 4,
      ...
      (1 : ℤ) • LaurentPolynomial.translate shift
        ((tropicalComponentARawFactor8 3).factorProductPolynomial
  ...
  have h00 : shift + ((Pi.single (86 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (104 : Fin 144) (1 : ℤ)) + (Pi.single (48 : Fin 144) (1 : ℤ) +
  ...
  have h01 : shift + (Pi.single (86 : Fin 144) (1 : ℤ) +
        Pi.single (87 : Fin 144) (-1 : ℤ) +
        Pi.single (101 : Fin 144) (-1 : ℤ) +
        Pi.single (104 : Fin 144) (1 : ℤ)) = (Pi.single (1 : Fin 144) (1 : ℤ) +
