import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.E013.Uses

/-!
# Component-A factor edge 13: translated product equality
-/
    ...
    (∑ k : Fin 4,
      ...
      (1 : ℤ) • LaurentPolynomial.translate shift
        ((tropicalComponentARawFactor8 1).factorProductPolynomial
          (tropicalComponentARawFactor8 47)) := by
