...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.Vertex.V057

/-!
# Row-local data for Component-A factor edge 7
-/
...
def sourceRelation : LaurentPolynomial (Fin 144) :=
  TropicalFactorA8.Internal.Quotient045.relation
...
def rightFactor : SignedCharacterRow (Fin 144) :=
  TropicalFactorA8.Internal.Vertex057.row
