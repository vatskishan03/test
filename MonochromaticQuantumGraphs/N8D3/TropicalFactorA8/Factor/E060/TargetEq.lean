import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.E060.Uses

/-!
# Component-A factor edge 60: translated product equality
-/
...
theorem target_eq :
    (∑ k : Fin 4,
      ...
      (1 : ℤ) • LaurentPolynomial.translate shift
        ((tropicalComponentARawFactor8 38).factorProductPolynomial
          (tropicalComponentARawFactor8 46)) := by
  have h00 : shift + ((Pi.single (15 : Fin 144) (1 : ℤ) +
        Pi.single (17 : Fin 144) (-1 : ℤ) +
        Pi.single (70 : Fin 144) (-1 : ℤ) +
        Pi.single (76 : Fin 144) (1 : ℤ)) + (Pi.single (6 : Fin 144) (1 : ℤ) +
  ...
  have h01 : shift + (Pi.single (15 : Fin 144) (1 : ℤ) +
        Pi.single (17 : Fin 144) (-1 : ℤ) +
        Pi.single (70 : Fin 144) (-1 : ℤ) +
        Pi.single (76 : Fin 144) (1 : ℤ)) = (Pi.single (7 : Fin 144) (1 : ℤ) +
        Pi.single (26 : Fin 144) (1 : ℤ) +
        Pi.single (48 : Fin 144) (1 : ℤ) +
        Pi.single (76 : Fin 144) (1 : ℤ) +
        Pi.single (117 : Fin 144) (1 : ℤ)) := by
