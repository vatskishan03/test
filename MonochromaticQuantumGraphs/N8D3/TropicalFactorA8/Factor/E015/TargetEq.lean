import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.E015.Uses

/-!
# Component-A factor edge 15: translated product equality
-/
...
theorem target_eq :
    (∑ k : Fin 4,
      ...
      (1 : ℤ) • LaurentPolynomial.translate shift
        ((tropicalComponentARawFactor8 1).factorProductPolynomial
          (tropicalComponentARawFactor8 49)) := by
  have h00 : shift + ((Pi.single (88 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (77 : Fin 144) (1 : ℤ))) = (Pi.single (26 : Fin 144) (1 : ℤ) +
        Pi.single (51 : Fin 144) (1 : ℤ) +
  ...
  have h02 : shift + (Pi.single (6 : Fin 144) (1 : ℤ) +
    ...
    unfold shift
    abel
  have h03 : shift + (0 : LaurentExponent (Fin 144)) = (Pi.single (6 : Fin 144) (-1 : ℤ) +
        Pi.single (7 : Fin 144) (1 : ℤ) +
        Pi.single (26 : Fin 144) (1 : ℤ) +
        Pi.single (48 : Fin 144) (1 : ℤ) +
        Pi.single (59 : Fin 144) (-1 : ℤ) +
