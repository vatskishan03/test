...
private def tropicalComponentAFactorEdge009Monomial008 :
...
private def tropicalComponentAFactorEdge009Monomial018 :
    MonomialReductionCertificate tropicalComponentACharacter8
      (Pi.single (26 : Fin 144) (1 : ℤ) +
        Pi.single (48 : Fin 144) (1 : ℤ) +
        Pi.single (59 : Fin 144) (-1 : ℤ) +
...
private def tropicalComponentAFactorEdge009Monomial028 :
    MonomialReductionCertificate tropicalComponentACharacter8
      (Pi.single (26 : Fin 144) (1 : ℤ) +
        Pi.single (48 : Fin 144) (1 : ℤ) +
...
private def tropicalComponentAFactorEdge009Monomial038 :
    MonomialReductionCertificate tropicalComponentACharacter8
      (Pi.single (26 : Fin 144) (1 : ℤ) +
        Pi.single (48 : Fin 144) (1 : ℤ) +
        Pi.single (75 : Fin 144) (1 : ℤ) +
...
private def tropicalComponentAFactorEdge009Use8 :
...
![
  { coefficient := (1 : ℤ)
      ...
      targetExponent := (Pi.single (26 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (89 : Fin 144) (1 : ℤ) +
        Pi.single (117 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentAFactorEdge009Monomial008 },
  { coefficient := (-1 : ℤ)
      sourceExponent := (Pi.single (26 : Fin 144) (1 : ℤ) +
        Pi.single (48 : Fin 144) (1 : ℤ) +
        Pi.single (59 : Fin 144) (-1 : ℤ) +
      ...
      targetExponent := (Pi.single (26 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (88 : Fin 144) (1 : ℤ) +
        Pi.single (120 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentAFactorEdge009Monomial018 },
  { coefficient := (-1 : ℤ)
      sourceExponent := (Pi.single (26 : Fin 144) (1 : ℤ) +
        Pi.single (48 : Fin 144) (1 : ℤ) +
        Pi.single (75 : Fin 144) (1 : ℤ) +
      ...
      targetExponent := (Pi.single (26 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (89 : Fin 144) (1 : ℤ) +
        Pi.single (117 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentAFactorEdge009Monomial028 },
  { coefficient := (1 : ℤ)
      sourceExponent := (Pi.single (26 : Fin 144) (1 : ℤ) +
        Pi.single (48 : Fin 144) (1 : ℤ) +
        Pi.single (75 : Fin 144) (1 : ℤ) +
      ...
      targetExponent := (Pi.single (26 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (88 : Fin 144) (1 : ℤ) +
        Pi.single (120 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentAFactorEdge009Monomial038 }
]

private theorem tropicalComponentAFactorEdge009_source_eq :
    (∑ k : Fin 4,
      Finsupp.single (tropicalComponentAFactorEdge009Use8 k).sourceExponent
        (tropicalComponentAFactorEdge009Use8 k).coefficient) =
      tropicalComponentAQuotientRelation8 40 := by
  decide

private theorem tropicalComponentAFactorEdge009_target_eq :
    (∑ k : Fin 4,
      Finsupp.single (tropicalComponentAFactorEdge009Use8 k).targetExponent
        (signedCoefficient (tropicalComponentAFactorEdge009Use8 k).reduction.signExponent
          (tropicalComponentAFactorEdge009Use8 k).coefficient)) =
      (1 : ℤ) • LaurentPolynomial.translate (Pi.single (26 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (69 : Fin 144) (1 : ℤ) +
        Pi.single (89 : Fin 144) (1 : ℤ) +
        Pi.single (117 : Fin 144) (1 : ℤ)) ((tropicalComponentARawFactor8 1).factorProductPolynomial (tropicalComponentARawFactor8 22)) := by
  decide
...
def tropicalComponentAFactorCertificate8_009 :
  ...
  shift := (Pi.single (26 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (117 : Fin 144) (1 : ℤ))
  reduction := {
    use := tropicalComponentAFactorEdge009Use8
    source_eq := tropicalComponentAFactorEdge009_source_eq
    target_eq := tropicalComponentAFactorEdge009_target_eq
  }
