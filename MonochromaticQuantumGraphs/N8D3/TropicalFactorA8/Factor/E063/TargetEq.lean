import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.E063.Uses

/-!
# Component-A factor edge 63: translated product equality
-/
...
theorem target_eq :
    (∑ k : Fin 4,
      ...
      (1 : ℤ) • LaurentPolynomial.translate shift
        ((tropicalComponentARawFactor8 41).factorProductPolynomial
