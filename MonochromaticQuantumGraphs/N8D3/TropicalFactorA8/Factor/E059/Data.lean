...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.Vertex.V037
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.Vertex.V046

/-!
# Row-local data for Component-A factor edge 59
-/
...
def sourceRelation : LaurentPolynomial (Fin 144) :=
  TropicalFactorA8.Internal.Quotient038.relation
