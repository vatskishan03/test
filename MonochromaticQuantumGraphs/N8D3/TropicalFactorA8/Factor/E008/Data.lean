...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.Vertex.V058

/-!
# Row-local data for Component-A factor edge 8
-/
...
def sourceRelation : LaurentPolynomial (Fin 144) :=
  TropicalFactorA8.Internal.Quotient049.relation
...
def rightFactor : SignedCharacterRow (Fin 144) :=
  TropicalFactorA8.Internal.Vertex058.row
