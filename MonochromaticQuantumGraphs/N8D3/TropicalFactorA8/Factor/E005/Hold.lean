...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Quotient.Q060.Hold

/-!
# Component-A factor edge 5: exactly one quotient hold
-/
  ...
  factorValues_mul_eq_zero_of_certificate
    ...
    (by
      simpa [sourceRelation] using
        TropicalFactorA8.Internal.Quotient060.hold
          hSupport hEq hChars)

end TropicalFactorA8.Internal.Factor005

/-- Public product-vanishing API for raw factor edge 5. -/
theorem tropicalComponentARawFactorEdgeProduct8_005
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W)
    (hEq : EqSystemN 8 3 W) (hChars : TropicalComponentACharacters8 W) :
    TropicalFactorA8.Internal.Factor005.leftFactor.factorValue (tropicalSupportWeight8 W) *
      TropicalFactorA8.Internal.Factor005.rightFactor.factorValue (tropicalSupportWeight8 W) = 0 :=
  TropicalFactorA8.Internal.Factor005.product hSupport hEq hChars
