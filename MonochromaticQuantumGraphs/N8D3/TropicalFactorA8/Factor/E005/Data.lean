...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.Vertex.V055

/-!
# Row-local data for Component-A factor edge 5
-/
...
def rightFactor : SignedCharacterRow (Fin 144) :=
  TropicalFactorA8.Internal.Vertex055.row
