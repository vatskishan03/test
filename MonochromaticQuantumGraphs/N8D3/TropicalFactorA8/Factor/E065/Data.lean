...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.Vertex.V043
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.Vertex.V053

/-!
# Row-local data for Component-A factor edge 65
-/
...
def sourceRelation : LaurentPolynomial (Fin 144) :=
  TropicalFactorA8.Internal.Quotient058.relation

/-- Left raw-factor endpoint. -/
def leftFactor : SignedCharacterRow (Fin 144) :=
  TropicalFactorA8.Internal.Vertex043.row
