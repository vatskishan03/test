...
/-!
# Component-A raw factor edge 50
...
private def tropicalComponentAFactorEdge050Monomial008 :
...
private def tropicalComponentAFactorEdge050Monomial018 :
    MonomialReductionCertificate tropicalComponentACharacter8
      (Pi.single (7 : Fin 144) (1 : ℤ) +
        Pi.single (48 : Fin 144) (-1 : ℤ) +
        Pi.single (49 : Fin 144) (1 : ℤ) +
...
private def tropicalComponentAFactorEdge050Monomial028 :
    MonomialReductionCertificate tropicalComponentACharacter8
      (Pi.single (7 : Fin 144) (1 : ℤ) +
        Pi.single (59 : Fin 144) (1 : ℤ) +
        Pi.single (85 : Fin 144) (1 : ℤ) +
...
private def tropicalComponentAFactorEdge050Monomial038 :
    MonomialReductionCertificate tropicalComponentACharacter8
      (Pi.single (7 : Fin 144) (1 : ℤ) +
        Pi.single (58 : Fin 144) (1 : ℤ) +
        Pi.single (90 : Fin 144) (1 : ℤ) +
...
private def tropicalComponentAFactorEdge050Use8 :
...
![
  { coefficient := (1 : ℤ)
      ...
      targetExponent := (Pi.single (7 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (104 : Fin 144) (1 : ℤ) +
        Pi.single (138 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentAFactorEdge050Monomial008 },
  { coefficient := (-1 : ℤ)
      sourceExponent := (Pi.single (7 : Fin 144) (1 : ℤ) +
        Pi.single (48 : Fin 144) (-1 : ℤ) +
        Pi.single (49 : Fin 144) (1 : ℤ) +
      ...
      targetExponent := (Pi.single (7 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (98 : Fin 144) (1 : ℤ) +
        Pi.single (138 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentAFactorEdge050Monomial018 },
  { coefficient := (-1 : ℤ)
      sourceExponent := (Pi.single (7 : Fin 144) (1 : ℤ) +
        Pi.single (59 : Fin 144) (1 : ℤ) +
        Pi.single (85 : Fin 144) (1 : ℤ) +
      ...
      targetExponent := (Pi.single (7 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (104 : Fin 144) (1 : ℤ) +
        Pi.single (141 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentAFactorEdge050Monomial028 },
  { coefficient := (1 : ℤ)
      sourceExponent := (Pi.single (7 : Fin 144) (1 : ℤ) +
        Pi.single (58 : Fin 144) (1 : ℤ) +
        Pi.single (90 : Fin 144) (1 : ℤ) +
      ...
      targetExponent := (Pi.single (7 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (98 : Fin 144) (1 : ℤ) +
        Pi.single (141 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentAFactorEdge050Monomial038 }
]

private theorem tropicalComponentAFactorEdge050_source_eq :
    (∑ k : Fin 4,
      Finsupp.single (tropicalComponentAFactorEdge050Use8 k).sourceExponent
        (tropicalComponentAFactorEdge050Use8 k).coefficient) =
      tropicalComponentAQuotientRelation8 7 := by
  decide

private theorem tropicalComponentAFactorEdge050_target_eq :
    (∑ k : Fin 4,
      Finsupp.single (tropicalComponentAFactorEdge050Use8 k).targetExponent
        (signedCoefficient (tropicalComponentAFactorEdge050Use8 k).reduction.signExponent
          (tropicalComponentAFactorEdge050Use8 k).coefficient)) =
      (1 : ℤ) • LaurentPolynomial.translate (Pi.single (7 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (85 : Fin 144) (1 : ℤ) +
        Pi.single (104 : Fin 144) (1 : ℤ) +
        Pi.single (138 : Fin 144) (1 : ℤ)) ((tropicalComponentARawFactor8 26).factorProductPolynomial (tropicalComponentARawFactor8 36)) := by
  decide
...
def tropicalComponentAFactorCertificate8_050 :
  ...
  shift := (Pi.single (7 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (138 : Fin 144) (1 : ℤ))
  reduction := {
    use := tropicalComponentAFactorEdge050Use8
    source_eq := tropicalComponentAFactorEdge050_source_eq
    target_eq := tropicalComponentAFactorEdge050_target_eq
  }
