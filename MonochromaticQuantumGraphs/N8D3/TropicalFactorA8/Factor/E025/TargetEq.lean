import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.E025.Uses

/-!
# Component-A factor edge 25: translated product equality
-/
...
theorem target_eq :
    (∑ k : Fin 4,
      ...
      (1 : ℤ) • LaurentPolynomial.translate shift
        ((tropicalComponentARawFactor8 5).factorProductPolynomial
          (tropicalComponentARawFactor8 33)) := by
  have h00 : shift + ((Pi.single (86 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (75 : Fin 144) (1 : ℤ))) = (Pi.single (19 : Fin 144) (1 : ℤ) +
    ...
    unfold shift
    abel
  have h01 : shift + (Pi.single (86 : Fin 144) (1 : ℤ) +
        Pi.single (87 : Fin 144) (-1 : ℤ) +
        Pi.single (119 : Fin 144) (-1 : ℤ) +
  ...
  have h02 : shift + (Pi.single (58 : Fin 144) (1 : ℤ) +
    ...
    unfold shift
    abel
  have h03 : shift + (0 : LaurentExponent (Fin 144)) = (Pi.single (19 : Fin 144) (1 : ℤ) +
        Pi.single (51 : Fin 144) (1 : ℤ) +
        Pi.single (58 : Fin 144) (-1 : ℤ) +
        Pi.single (64 : Fin 144) (1 : ℤ) +
        Pi.single (69 : Fin 144) (1 : ℤ) +
