...
/-!
# Component-A raw factor edge 19
...
private def tropicalComponentAFactorEdge019Monomial008 :
...
private def tropicalComponentAFactorEdge019Monomial018 :
    MonomialReductionCertificate tropicalComponentACharacter8
      (Pi.single (6 : Fin 144) (-1 : ℤ) +
        Pi.single (7 : Fin 144) (1 : ℤ) +
        Pi.single (26 : Fin 144) (1 : ℤ) +
...
private def tropicalComponentAFactorEdge019Monomial028 :
    MonomialReductionCertificate tropicalComponentACharacter8
      (Pi.single (26 : Fin 144) (1 : ℤ) +
...
private def tropicalComponentAFactorEdge019Monomial038 :
    MonomialReductionCertificate tropicalComponentACharacter8
      (Pi.single (26 : Fin 144) (1 : ℤ) +
        Pi.single (51 : Fin 144) (1 : ℤ) +
        Pi.single (69 : Fin 144) (1 : ℤ) +
...
private def tropicalComponentAFactorEdge019Use8 :
...
![
  { coefficient := (1 : ℤ)
      ...
      targetExponent := (Pi.single (6 : Fin 144) (-1 : ℤ) +
        ...
        Pi.single (90 : Fin 144) (1 : ℤ) +
        Pi.single (117 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentAFactorEdge019Monomial008 },
  { coefficient := (-1 : ℤ)
      sourceExponent := (Pi.single (6 : Fin 144) (-1 : ℤ) +
        Pi.single (7 : Fin 144) (1 : ℤ) +
        Pi.single (26 : Fin 144) (1 : ℤ) +
      ...
      targetExponent := (Pi.single (6 : Fin 144) (-1 : ℤ) +
        ...
        Pi.single (88 : Fin 144) (1 : ℤ) +
        Pi.single (123 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentAFactorEdge019Monomial018 },
  { coefficient := (-1 : ℤ)
      ...
      targetExponent := (Pi.single (26 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (90 : Fin 144) (1 : ℤ) +
        Pi.single (117 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentAFactorEdge019Monomial028 },
  { coefficient := (1 : ℤ)
      sourceExponent := (Pi.single (26 : Fin 144) (1 : ℤ) +
        Pi.single (51 : Fin 144) (1 : ℤ) +
        Pi.single (69 : Fin 144) (1 : ℤ) +
      ...
      targetExponent := (Pi.single (26 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (88 : Fin 144) (1 : ℤ) +
        Pi.single (123 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentAFactorEdge019Monomial038 }
]

private theorem tropicalComponentAFactorEdge019_source_eq :
    (∑ k : Fin 4,
      Finsupp.single (tropicalComponentAFactorEdge019Use8 k).sourceExponent
        (tropicalComponentAFactorEdge019Use8 k).coefficient) =
      tropicalComponentAQuotientRelation8 42 := by
  decide

private theorem tropicalComponentAFactorEdge019_target_eq :
    (∑ k : Fin 4,
      Finsupp.single (tropicalComponentAFactorEdge019Use8 k).targetExponent
        (signedCoefficient (tropicalComponentAFactorEdge019Use8 k).reduction.signExponent
          (tropicalComponentAFactorEdge019Use8 k).coefficient)) =
      (1 : ℤ) • LaurentPolynomial.translate (Pi.single (6 : Fin 144) (-1 : ℤ) +
        ...
        Pi.single (69 : Fin 144) (1 : ℤ) +
        Pi.single (90 : Fin 144) (1 : ℤ) +
        Pi.single (117 : Fin 144) (1 : ℤ)) ((tropicalComponentARawFactor8 2).factorProductPolynomial (tropicalComponentARawFactor8 46)) := by
  decide
...
def tropicalComponentAFactorCertificate8_019 :
  ...
  shift := (Pi.single (6 : Fin 144) (-1 : ℤ) +
        ...
        Pi.single (117 : Fin 144) (1 : ℤ))
  reduction := {
    use := tropicalComponentAFactorEdge019Use8
    source_eq := tropicalComponentAFactorEdge019_source_eq
    target_eq := tropicalComponentAFactorEdge019_target_eq
  }
