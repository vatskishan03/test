...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.Vertex.V013
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.Vertex.V036

/-!
# Row-local data for Component-A factor edge 40
-/
...
def sourceRelation : LaurentPolynomial (Fin 144) :=
  TropicalFactorA8.Internal.Quotient000.relation
