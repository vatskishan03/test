import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.E040.Uses

/-!
# Component-A factor edge 40: translated product equality
-/
...
theorem target_eq :
    (∑ k : Fin 4,
      ...
      (1 : ℤ) • LaurentPolynomial.translate shift
        ((tropicalComponentARawFactor8 13).factorProductPolynomial
          (tropicalComponentARawFactor8 36)) := by
  have h00 : shift + ((Pi.single (69 : Fin 144) (1 : ℤ) +
        Pi.single (70 : Fin 144) (-1 : ℤ) +
        Pi.single (126 : Fin 144) (-1 : ℤ) +
        Pi.single (129 : Fin 144) (1 : ℤ)) + (Pi.single (48 : Fin 144) (1 : ℤ) +
    ...
    unfold shift
    abel
  have h01 : shift + (Pi.single (69 : Fin 144) (1 : ℤ) +
        Pi.single (70 : Fin 144) (-1 : ℤ) +
        Pi.single (126 : Fin 144) (-1 : ℤ) +
