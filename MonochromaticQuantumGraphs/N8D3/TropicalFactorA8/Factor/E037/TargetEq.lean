import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.E037.Uses

/-!
# Component-A factor edge 37: translated product equality
-/
...
theorem target_eq :
  ...
  have h00 : shift + ((Pi.single (85 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (76 : Fin 144) (1 : ℤ))) = (Pi.single (25 : Fin 144) (1 : ℤ) +
