...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.Vertex.V050

/-!
# Row-local data for Component-A factor edge 57
-/
...
def sourceRelation : LaurentPolynomial (Fin 144) :=
  TropicalFactorA8.Internal.Quotient012.relation
...
def rightFactor : SignedCharacterRow (Fin 144) :=
  TropicalFactorA8.Internal.Vertex050.row
