import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.E006.Uses

/-!
# Component-A factor edge 6: translated product equality
-/
    ...
    (∑ k : Fin 4,
      ...
      (1 : ℤ) • LaurentPolynomial.translate shift
        ((tropicalComponentARawFactor8 0).factorProductPolynomial
          (tropicalComponentARawFactor8 56)) := by
