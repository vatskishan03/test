import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.E044.Uses

/-!
# Component-A factor edge 44: translated product equality
-/
...
theorem target_eq :
    (∑ k : Fin 4,
      ...
      (1 : ℤ) • LaurentPolynomial.translate shift
        ((tropicalComponentARawFactor8 17).factorProductPolynomial
  ...
  have h00 : shift + ((Pi.single (64 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (101 : Fin 144) (-1 : ℤ)) + (Pi.single (48 : Fin 144) (1 : ℤ) +
  ...
  have h01 : shift + (Pi.single (64 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (89 : Fin 144) (1 : ℤ) +
        Pi.single (98 : Fin 144) (1 : ℤ) +
        Pi.single (101 : Fin 144) (-1 : ℤ)) = (Pi.single (7 : Fin 144) (1 : ℤ) +
