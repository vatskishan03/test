...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.Vertex.V017
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.Vertex.V036

/-!
# Row-local data for Component-A factor edge 44
-/
...
def sourceRelation : LaurentPolynomial (Fin 144) :=
  TropicalFactorA8.Internal.Quotient010.relation
