...
/-!
# Component-A raw factor edge 34
...
private def tropicalComponentAFactorEdge034Monomial008 :
...
private def tropicalComponentAFactorEdge034Monomial018 :
    MonomialReductionCertificate tropicalComponentACharacter8
      (Pi.single (7 : Fin 144) (1 : ℤ) +
        Pi.single (48 : Fin 144) (-1 : ℤ) +
        Pi.single (49 : Fin 144) (1 : ℤ) +
...
private def tropicalComponentAFactorEdge034Monomial028 :
    MonomialReductionCertificate tropicalComponentACharacter8
      (Pi.single (7 : Fin 144) (1 : ℤ) +
        Pi.single (58 : Fin 144) (1 : ℤ) +
        Pi.single (87 : Fin 144) (1 : ℤ) +
...
private def tropicalComponentAFactorEdge034Monomial038 :
    MonomialReductionCertificate tropicalComponentACharacter8
      (Pi.single (7 : Fin 144) (1 : ℤ) +
        Pi.single (58 : Fin 144) (1 : ℤ) +
        Pi.single (85 : Fin 144) (1 : ℤ) +
...
private def tropicalComponentAFactorEdge034Use8 :
...
![
  { coefficient := (1 : ℤ)
      ...
      targetExponent := (Pi.single (7 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (98 : Fin 144) (1 : ℤ) +
        Pi.single (138 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentAFactorEdge034Monomial008 },
  { coefficient := (-1 : ℤ)
      sourceExponent := (Pi.single (7 : Fin 144) (1 : ℤ) +
        Pi.single (48 : Fin 144) (-1 : ℤ) +
        Pi.single (49 : Fin 144) (1 : ℤ) +
      ...
      targetExponent := (Pi.single (7 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (104 : Fin 144) (1 : ℤ) +
        Pi.single (138 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentAFactorEdge034Monomial018 },
  { coefficient := (-1 : ℤ)
      sourceExponent := (Pi.single (7 : Fin 144) (1 : ℤ) +
        Pi.single (58 : Fin 144) (1 : ℤ) +
        Pi.single (87 : Fin 144) (1 : ℤ) +
      ...
      targetExponent := (Pi.single (7 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (98 : Fin 144) (1 : ℤ) +
        Pi.single (141 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentAFactorEdge034Monomial028 },
  { coefficient := (1 : ℤ)
      sourceExponent := (Pi.single (7 : Fin 144) (1 : ℤ) +
        Pi.single (58 : Fin 144) (1 : ℤ) +
        Pi.single (85 : Fin 144) (1 : ℤ) +
      ...
      targetExponent := (Pi.single (7 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (104 : Fin 144) (1 : ℤ) +
        Pi.single (141 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentAFactorEdge034Monomial038 }
]

private theorem tropicalComponentAFactorEdge034_source_eq :
    (∑ k : Fin 4,
      Finsupp.single (tropicalComponentAFactorEdge034Use8 k).sourceExponent
        (tropicalComponentAFactorEdge034Use8 k).coefficient) =
      tropicalComponentAQuotientRelation8 5 := by
  decide

private theorem tropicalComponentAFactorEdge034_target_eq :
    (∑ k : Fin 4,
      Finsupp.single (tropicalComponentAFactorEdge034Use8 k).targetExponent
        (signedCoefficient (tropicalComponentAFactorEdge034Use8 k).reduction.signExponent
          (tropicalComponentAFactorEdge034Use8 k).coefficient)) =
      (1 : ℤ) • LaurentPolynomial.translate (Pi.single (7 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (87 : Fin 144) (1 : ℤ) +
        Pi.single (98 : Fin 144) (1 : ℤ) +
        Pi.single (138 : Fin 144) (1 : ℤ)) ((tropicalComponentARawFactor8 9).factorProductPolynomial (tropicalComponentARawFactor8 36)) := by
  decide

/-- Exact Laurent factor certificate for raw edge 34. -/
def tropicalComponentAFactorCertificate8_034 :
  ...
  shift := (Pi.single (7 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (138 : Fin 144) (1 : ℤ))
  reduction := {
    use := tropicalComponentAFactorEdge034Use8
    source_eq := tropicalComponentAFactorEdge034_source_eq
    target_eq := tropicalComponentAFactorEdge034_target_eq
  }
