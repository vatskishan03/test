import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.E016.Uses

/-!
# Component-A factor edge 16: translated product equality
-/
    ...
    (∑ k : Fin 4,
      ...
      (1 : ℤ) • LaurentPolynomial.translate shift
        ((tropicalComponentARawFactor8 2).factorProductPolynomial
          (tropicalComponentARawFactor8 22)) := by
