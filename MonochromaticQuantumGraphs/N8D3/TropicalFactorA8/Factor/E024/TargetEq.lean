import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.E024.Uses

/-!
# Component-A factor edge 24: translated product equality
-/
...
theorem target_eq :
    (∑ k : Fin 4,
      ...
      (1 : ℤ) • LaurentPolynomial.translate shift
        ((tropicalComponentARawFactor8 4).factorProductPolynomial
  ...
  have h01 : shift + (Pi.single (86 : Fin 144) (1 : ℤ) +
        Pi.single (87 : Fin 144) (-1 : ℤ) +
        Pi.single (102 : Fin 144) (-1 : ℤ) +
        Pi.single (105 : Fin 144) (1 : ℤ)) = (Pi.single (1 : Fin 144) (1 : ℤ) +
