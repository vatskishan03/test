...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.Vertex.V004
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.Vertex.V036

/-!
# Row-local data for Component-A factor edge 24
-/
...
def sourceRelation : LaurentPolynomial (Fin 144) :=
  TropicalFactorA8.Internal.Quotient031.relation
