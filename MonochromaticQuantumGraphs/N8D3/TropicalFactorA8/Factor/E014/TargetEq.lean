import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.E014.Uses

/-!
# Component-A factor edge 14: translated product equality
-/
    ...
    (∑ k : Fin 4,
      ...
      (1 : ℤ) • LaurentPolynomial.translate shift
        ((tropicalComponentARawFactor8 1).factorProductPolynomial
          (tropicalComponentARawFactor8 48)) := by
