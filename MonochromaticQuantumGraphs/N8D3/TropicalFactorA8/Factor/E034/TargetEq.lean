import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.E034.Uses

/-!
# Component-A factor edge 34: translated product equality
-/
...
theorem target_eq :
    (∑ k : Fin 4,
      ...
      (1 : ℤ) • LaurentPolynomial.translate shift
        ((tropicalComponentARawFactor8 9).factorProductPolynomial
  ...
  have h01 : shift + (Pi.single (85 : Fin 144) (1 : ℤ) +
        Pi.single (87 : Fin 144) (-1 : ℤ) +
        Pi.single (98 : Fin 144) (-1 : ℤ) +
        Pi.single (104 : Fin 144) (1 : ℤ)) = (Pi.single (7 : Fin 144) (1 : ℤ) +
