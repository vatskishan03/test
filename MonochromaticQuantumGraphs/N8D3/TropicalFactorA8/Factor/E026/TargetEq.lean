import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.E026.Uses

/-!
# Component-A factor edge 26: translated product equality
-/
...
theorem target_eq :
    (∑ k : Fin 4,
      ...
      (1 : ℤ) • LaurentPolynomial.translate shift
        ((tropicalComponentARawFactor8 5).factorProductPolynomial
          (tropicalComponentARawFactor8 34)) := by
  have h00 : shift + ((Pi.single (86 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (76 : Fin 144) (1 : ℤ))) = (Pi.single (19 : Fin 144) (1 : ℤ) +
