...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.Vertex.V033

/-!
# Row-local data for Component-A factor edge 36
-/
...
def sourceRelation : LaurentPolynomial (Fin 144) :=
  TropicalFactorA8.Internal.Quotient006.relation
