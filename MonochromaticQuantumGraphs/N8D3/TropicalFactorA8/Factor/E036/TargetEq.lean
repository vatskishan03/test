import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.E036.Uses

/-!
# Component-A factor edge 36: translated product equality
-/
...
theorem target_eq :
    (∑ k : Fin 4,
      ...
      (1 : ℤ) • LaurentPolynomial.translate shift
        ((tropicalComponentARawFactor8 11).factorProductPolynomial
  ...
  have h00 : shift + ((Pi.single (85 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (75 : Fin 144) (1 : ℤ))) = (Pi.single (25 : Fin 144) (1 : ℤ) +
