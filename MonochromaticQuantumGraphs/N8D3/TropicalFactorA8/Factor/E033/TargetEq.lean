import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.E033.Uses

/-!
# Component-A factor edge 33: translated product equality
-/
...
theorem target_eq :
    (∑ k : Fin 4,
      ...
      (1 : ℤ) • LaurentPolynomial.translate shift
        ((tropicalComponentARawFactor8 8).factorProductPolynomial
  ...
  have h00 : shift + ((Pi.single (85 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (119 : Fin 144) (1 : ℤ)) + (Pi.single (58 : Fin 144) (1 : ℤ) +
