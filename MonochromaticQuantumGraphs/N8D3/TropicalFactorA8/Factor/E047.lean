...
/-!
# Component-A raw factor edge 47
...
private def tropicalComponentAFactorEdge047Monomial008 :
...
private def tropicalComponentAFactorEdge047Monomial018 :
    MonomialReductionCertificate tropicalComponentACharacter8
      (Pi.single (1 : Fin 144) (1 : ℤ) +
        Pi.single (48 : Fin 144) (-1 : ℤ) +
        Pi.single (49 : Fin 144) (1 : ℤ) +
...
private def tropicalComponentAFactorEdge047Monomial028 :
    MonomialReductionCertificate tropicalComponentACharacter8
      (Pi.single (1 : Fin 144) (1 : ℤ) +
        Pi.single (65 : Fin 144) (1 : ℤ) +
        Pi.single (86 : Fin 144) (1 : ℤ) +
...
private def tropicalComponentAFactorEdge047Monomial038 :
    MonomialReductionCertificate tropicalComponentACharacter8
      (Pi.single (1 : Fin 144) (1 : ℤ) +
        Pi.single (64 : Fin 144) (1 : ℤ) +
        Pi.single (90 : Fin 144) (1 : ℤ) +
...
private def tropicalComponentAFactorEdge047Use8 :
...
![
  { coefficient := (1 : ℤ)
      ...
      targetExponent := (Pi.single (1 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (104 : Fin 144) (1 : ℤ) +
        Pi.single (138 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentAFactorEdge047Monomial008 },
  { coefficient := (-1 : ℤ)
      sourceExponent := (Pi.single (1 : Fin 144) (1 : ℤ) +
        Pi.single (48 : Fin 144) (-1 : ℤ) +
        Pi.single (49 : Fin 144) (1 : ℤ) +
      ...
      targetExponent := (Pi.single (1 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (101 : Fin 144) (1 : ℤ) +
        Pi.single (138 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentAFactorEdge047Monomial018 },
  { coefficient := (-1 : ℤ)
      sourceExponent := (Pi.single (1 : Fin 144) (1 : ℤ) +
        Pi.single (65 : Fin 144) (1 : ℤ) +
        Pi.single (86 : Fin 144) (1 : ℤ) +
      ...
      targetExponent := (Pi.single (1 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (104 : Fin 144) (1 : ℤ) +
        Pi.single (141 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentAFactorEdge047Monomial028 },
  { coefficient := (1 : ℤ)
      sourceExponent := (Pi.single (1 : Fin 144) (1 : ℤ) +
        Pi.single (64 : Fin 144) (1 : ℤ) +
        Pi.single (90 : Fin 144) (1 : ℤ) +
      ...
      targetExponent := (Pi.single (1 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (101 : Fin 144) (1 : ℤ) +
        Pi.single (141 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentAFactorEdge047Monomial038 }
]

private theorem tropicalComponentAFactorEdge047_source_eq :
    (∑ k : Fin 4,
      Finsupp.single (tropicalComponentAFactorEdge047Use8 k).sourceExponent
        (tropicalComponentAFactorEdge047Use8 k).coefficient) =
      tropicalComponentAQuotientRelation8 22 := by
  decide

private theorem tropicalComponentAFactorEdge047_target_eq :
    (∑ k : Fin 4,
      Finsupp.single (tropicalComponentAFactorEdge047Use8 k).targetExponent
        (signedCoefficient (tropicalComponentAFactorEdge047Use8 k).reduction.signExponent
          (tropicalComponentAFactorEdge047Use8 k).coefficient)) =
      (1 : ℤ) • LaurentPolynomial.translate (Pi.single (1 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (86 : Fin 144) (1 : ℤ) +
        Pi.single (104 : Fin 144) (1 : ℤ) +
        Pi.single (138 : Fin 144) (1 : ℤ)) ((tropicalComponentARawFactor8 20).factorProductPolynomial (tropicalComponentARawFactor8 36)) := by
  decide
...
def tropicalComponentAFactorCertificate8_047 :
  ...
  shift := (Pi.single (1 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (138 : Fin 144) (1 : ℤ))
  reduction := {
    use := tropicalComponentAFactorEdge047Use8
    source_eq := tropicalComponentAFactorEdge047_source_eq
    target_eq := tropicalComponentAFactorEdge047_target_eq
  }
