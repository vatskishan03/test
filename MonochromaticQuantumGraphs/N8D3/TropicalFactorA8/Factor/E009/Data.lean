...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Factor.Vertex.V022

/-!
# Row-local data for Component-A factor edge 9
-/
...
def sourceRelation : LaurentPolynomial (Fin 144) :=
  TropicalFactorA8.Internal.Quotient040.relation
