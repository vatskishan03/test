...
/-!
# Component-A quotient row 32: shifted-source equality
-/
...
theorem shifted_eq :
  ...
  have h02 : (((Pi.single (58 : Fin 144) (-1 : ℤ) +
        ...
        Pi.single (129 : Fin 144) (1 : ℤ)) : LaurentExponent (Fin 144)) = (Pi.single (1 : Fin 144) (1 : ℤ) +
        Pi.single (64 : Fin 144) (1 : ℤ) +
        Pi.single (87 : Fin 144) (1 : ℤ) +
        Pi.single (111 : Fin 144) (1 : ℤ) +
  ...
  simp [shiftedUse, shiftedSources, TropicalFactorA8.Internal.Source033.reduced,
    TropicalFactorA8.Internal.Source035.reduced, intermediate,
    Fin.sum_univ_succ,
