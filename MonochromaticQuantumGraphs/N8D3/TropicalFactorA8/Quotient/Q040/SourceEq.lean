import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Quotient.Q040.Uses

/-!
# Component-A quotient row 40: intermediate source equality
-/
...
theorem source_eq :
    (∑ k : Fin 12,
      ...
      tropicalComponentAQuotientIntermediate8 40 := by
