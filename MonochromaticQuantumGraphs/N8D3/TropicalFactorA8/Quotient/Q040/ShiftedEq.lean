import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Quotient.Q040.Data

/-!
# Component-A quotient row 40: shifted-source equality
-/
...
theorem shifted_eq :
  ...
  have h11 : (((0 : LaurentExponent (Fin 144)) + (Pi.single (6 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (139 : Fin 144) (1 : ℤ))) := by
    abel
  simp [shiftedUse, shiftedSources, TropicalFactorA8.Internal.Source068.reduced,
    TropicalFactorA8.Internal.Source073.reduced, intermediate,
    Fin.sum_univ_succ,
