import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Quotient.Q045.Uses

/-!
# Component-A quotient row 45: intermediate source equality
-/
...
theorem source_eq :
    (∑ k : Fin 12,
      ...
      tropicalComponentAQuotientIntermediate8 45 := by
