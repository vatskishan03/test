import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Quotient.Q047.Certificate
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Source.S078.Hold
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Source.S085.Hold

/-!
# Component-A quotient row 47: exactly two source holds
-/
...
theorem hold
  ...
  have hintermediate :
    ...
    LaurentPolynomial.holds_of_shiftedCombinationCertificate
      ...
      tropicalComponentAQuotientShiftedCertificate8_047
      hsources
  exact holds_of_normalizedCharacterReductionCertificate
    (tropicalSupportWeight8 W) (tropicalSupportWeight8_ne_zero hSupport)
    tropicalComponentACharacter8 intermediate relation
    tropicalComponentAQuotientReductionCertificate8_047
    hChars hintermediate

end TropicalFactorA8.Internal.Quotient047

/-- Public quotient-hold API for row 47. -/
theorem tropicalComponentAQuotientRelation8_047_hold
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W)
    (hEq : EqSystemN 8 3 W) (hChars : TropicalComponentACharacters8 W) :
    TropicalFactorA8.Internal.Quotient047.relation.Holds (tropicalSupportWeight8 W) :=
  TropicalFactorA8.Internal.Quotient047.hold hSupport hEq hChars
