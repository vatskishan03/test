import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Quotient.Q066.Certificate
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Source.S110.Hold
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Source.S112.Hold

/-!
# Component-A quotient row 66: exactly two source holds
-/
...
theorem hold
  ...
  have hsources : ∀ s : Fin 2,
    ...
    · simpa [shiftedSources] using
        TropicalFactorA8.Internal.Source112.hold hSupport hEq hChars
  have hintermediate :
...
/-- Public quotient-hold API for row 66. -/
theorem tropicalComponentAQuotientRelation8_066_hold
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W)
    (hEq : EqSystemN 8 3 W) (hChars : TropicalComponentACharacters8 W) :
    TropicalFactorA8.Internal.Quotient066.relation.Holds (tropicalSupportWeight8 W) :=
  TropicalFactorA8.Internal.Quotient066.hold hSupport hEq hChars
