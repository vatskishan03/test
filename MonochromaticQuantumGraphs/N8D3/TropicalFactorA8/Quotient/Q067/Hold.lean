...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Source.S115.Hold

/-!
# Component-A quotient row 67: exactly two source holds
-/
...
/-- Public quotient-hold API for row 67. -/
theorem tropicalComponentAQuotientRelation8_067_hold
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W)
    (hEq : EqSystemN 8 3 W) (hChars : TropicalComponentACharacters8 W) :
    TropicalFactorA8.Internal.Quotient067.relation.Holds (tropicalSupportWeight8 W) :=
  TropicalFactorA8.Internal.Quotient067.hold hSupport hEq hChars
