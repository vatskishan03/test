import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Quotient.Q060.Data

/-!
# Component-A quotient row 60: shifted-source equality
-/
...
theorem shifted_eq :
  ...
  have h00 : (((Pi.single (0 : Fin 144) (-1 : ℤ) +
  ...
  have h01 : (((Pi.single (0 : Fin 144) (-1 : ℤ) +
        Pi.single (1 : Fin 144) (1 : ℤ) +
        Pi.single (59 : Fin 144) (-1 : ℤ) +
        Pi.single (65 : Fin 144) (1 : ℤ)) + (Pi.single (20 : Fin 144) (1 : ℤ) +
        Pi.single (48 : Fin 144) (1 : ℤ) +
    ...
    (ext x; simp [Pi.single_apply]; split_ifs <;> omega)
  have h02 : (((Pi.single (0 : Fin 144) (-1 : ℤ) +
        Pi.single (1 : Fin 144) (1 : ℤ) +
        Pi.single (59 : Fin 144) (-1 : ℤ) +
    ...
    (ext x; simp [Pi.single_apply]; split_ifs <;> omega)
  have h03 : (((Pi.single (0 : Fin 144) (-1 : ℤ) +
        Pi.single (1 : Fin 144) (1 : ℤ) +
        Pi.single (59 : Fin 144) (-1 : ℤ) +
        Pi.single (65 : Fin 144) (1 : ℤ)) + (Pi.single (0 : Fin 144) (1 : ℤ) +
        Pi.single (59 : Fin 144) (1 : ℤ) +
    ...
    (ext x; simp [Pi.single_apply]; split_ifs <;> omega)
  have h04 : (((Pi.single (0 : Fin 144) (-1 : ℤ) +
        Pi.single (1 : Fin 144) (1 : ℤ) +
        Pi.single (59 : Fin 144) (-1 : ℤ) +
        Pi.single (65 : Fin 144) (1 : ℤ)) + (Pi.single (0 : Fin 144) (1 : ℤ) +
        Pi.single (59 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (130 : Fin 144) (1 : ℤ))) := by
    (ext x; simp [Pi.single_apply]; split_ifs <;> omega)
  have h05 : (((Pi.single (0 : Fin 144) (-1 : ℤ) +
        Pi.single (1 : Fin 144) (1 : ℤ) +
        Pi.single (59 : Fin 144) (-1 : ℤ) +
        Pi.single (65 : Fin 144) (1 : ℤ)) + (Pi.single (0 : Fin 144) (1 : ℤ) +
        Pi.single (59 : Fin 144) (1 : ℤ) +
  ...
  simp [shiftedUse, shiftedSources, TropicalFactorA8.Internal.Source097.reduced,
    TropicalFactorA8.Internal.Source100.reduced, intermediate,
    Fin.sum_univ_succ,
