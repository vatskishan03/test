import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Quotient.Q042.Data

/-!
# Component-A quotient row 42: shifted-source equality
-/
...
theorem shifted_eq :
  ...
  have h00 : (((Pi.single (6 : Fin 144) (-1 : ℤ) +
        Pi.single (7 : Fin 144) (1 : ℤ)) + (Pi.single (26 : Fin 144) (1 : ℤ) +
  ...
  have h02 : (((Pi.single (6 : Fin 144) (-1 : ℤ) +
        Pi.single (7 : Fin 144) (1 : ℤ)) + (Pi.single (6 : Fin 144) (1 : ℤ) +
  ...
  simp [shiftedUse, shiftedSources, TropicalFactorA8.Internal.Source069.reduced,
    TropicalFactorA8.Internal.Source071.reduced, intermediate,
    Fin.sum_univ_succ,
