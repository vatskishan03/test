...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Source.S071.Hold

/-!
# Component-A quotient row 42: exactly two source holds
-/
...
theorem hold
  ...
  have hsources : ∀ s : Fin 2,
    ...
    · simpa [shiftedSources] using
        TropicalFactorA8.Internal.Source071.hold hSupport hEq hChars
  have hintermediate :
...
/-- Public quotient-hold API for row 42. -/
theorem tropicalComponentAQuotientRelation8_042_hold
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W)
    (hEq : EqSystemN 8 3 W) (hChars : TropicalComponentACharacters8 W) :
    TropicalFactorA8.Internal.Quotient042.relation.Holds (tropicalSupportWeight8 W) :=
  TropicalFactorA8.Internal.Quotient042.hold hSupport hEq hChars
