import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Quotient.Q056.Certificate
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Source.S090.Hold
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Source.S095.Hold

/-!
# Component-A quotient row 56: exactly two source holds
-/
...
theorem hold
  ...
  have hintermediate :
    ...
    LaurentPolynomial.holds_of_shiftedCombinationCertificate
      ...
      tropicalComponentAQuotientShiftedCertificate8_056
      hsources
  exact holds_of_normalizedCharacterReductionCertificate
    (tropicalSupportWeight8 W) (tropicalSupportWeight8_ne_zero hSupport)
    tropicalComponentACharacter8 intermediate relation
    tropicalComponentAQuotientReductionCertificate8_056
    hChars hintermediate

end TropicalFactorA8.Internal.Quotient056

/-- Public quotient-hold API for row 56. -/
theorem tropicalComponentAQuotientRelation8_056_hold
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W)
    (hEq : EqSystemN 8 3 W) (hChars : TropicalComponentACharacters8 W) :
    TropicalFactorA8.Internal.Quotient056.relation.Holds (tropicalSupportWeight8 W) :=
  TropicalFactorA8.Internal.Quotient056.hold hSupport hEq hChars
