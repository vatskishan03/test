import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Quotient.Q056.Uses

/-!
# Component-A quotient row 56: intermediate source equality
-/
...
theorem source_eq :
    (∑ k : Fin 12,
      ...
      tropicalComponentAQuotientIntermediate8 56 := by
