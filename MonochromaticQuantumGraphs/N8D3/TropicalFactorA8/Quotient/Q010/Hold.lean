...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Source.S009.Hold
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Source.S049.Hold

/-!
# Component-A quotient row 10: exactly two source holds
-/
...
theorem hold
  ...
  have hsources : ∀ s : Fin 2,
    ...
    · simpa [shiftedSources] using
        TropicalFactorA8.Internal.Source009.hold hSupport hEq hChars
    · simpa [shiftedSources] using
        TropicalFactorA8.Internal.Source049.hold hSupport hEq hChars
  have hintermediate :
...
/-- Public quotient-hold API for row 10. -/
theorem tropicalComponentAQuotientRelation8_010_hold
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W)
    (hEq : EqSystemN 8 3 W) (hChars : TropicalComponentACharacters8 W) :
    TropicalFactorA8.Internal.Quotient010.relation.Holds (tropicalSupportWeight8 W) :=
  TropicalFactorA8.Internal.Quotient010.hold hSupport hEq hChars
