import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Quotient.Q021.Uses

/-!
# Component-A quotient row 21: intermediate source equality
-/
...
theorem source_eq :
    (∑ k : Fin 12,
      ...
      tropicalComponentAQuotientIntermediate8 21 := by
