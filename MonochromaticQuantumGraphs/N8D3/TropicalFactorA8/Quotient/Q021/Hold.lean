...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Source.S017.Hold
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Source.S056.Hold

/-!
# Component-A quotient row 21: exactly two source holds
-/
...
theorem hold
  ...
  have hsources : ∀ s : Fin 2,
    ...
    · simpa [shiftedSources] using
        TropicalFactorA8.Internal.Source056.hold hSupport hEq hChars
  have hintermediate :
...
/-- Public quotient-hold API for row 21. -/
theorem tropicalComponentAQuotientRelation8_021_hold
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W)
    (hEq : EqSystemN 8 3 W) (hChars : TropicalComponentACharacters8 W) :
    TropicalFactorA8.Internal.Quotient021.relation.Holds (tropicalSupportWeight8 W) :=
  TropicalFactorA8.Internal.Quotient021.hold hSupport hEq hChars
