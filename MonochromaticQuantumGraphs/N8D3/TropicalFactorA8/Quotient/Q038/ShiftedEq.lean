import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Quotient.Q038.Data

/-!
# Component-A quotient row 38: shifted-source equality
-/
...
theorem shifted_eq :
  ...
  have h00 : (((Pi.single (15 : Fin 144) (-1 : ℤ) +
        ...
        Pi.single (117 : Fin 144) (1 : ℤ)) : LaurentExponent (Fin 144)) = (Pi.single (7 : Fin 144) (1 : ℤ) +
  ...
  have h11 : (((0 : LaurentExponent (Fin 144)) + (Pi.single (6 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (139 : Fin 144) (1 : ℤ))) := by
    (ext x; simp [Pi.single_apply] <;> split_ifs <;> omega)
  simp [shiftedUse, shiftedSources, TropicalFactorA8.Internal.Source067.reduced,
    TropicalFactorA8.Internal.Source072.reduced, intermediate,
    Fin.sum_univ_succ,
