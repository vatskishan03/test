...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Source.S000.Hold
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Source.S023.Hold

/-!
# Component-A quotient row 0: exactly two source holds
-/
...
theorem hold
  ...
  have hsources : ∀ s : Fin 2,
    ...
    · simpa [shiftedSources] using
        TropicalFactorA8.Internal.Source000.hold hSupport hEq hChars
    · simpa [shiftedSources] using
        TropicalFactorA8.Internal.Source023.hold hSupport hEq hChars
  have hintermediate :
...
/-- Public quotient-hold API for row 0. -/
theorem tropicalComponentAQuotientRelation8_000_hold
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W)
    (hEq : EqSystemN 8 3 W) (hChars : TropicalComponentACharacters8 W) :
    TropicalFactorA8.Internal.Quotient000.relation.Holds (tropicalSupportWeight8 W) :=
  TropicalFactorA8.Internal.Quotient000.hold hSupport hEq hChars
