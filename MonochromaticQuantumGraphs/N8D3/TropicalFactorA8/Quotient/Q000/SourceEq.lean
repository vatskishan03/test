import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Quotient.Q000.Uses

/-!
# Component-A quotient row 0: intermediate source equality
-/
...
theorem source_eq :
    (∑ k : Fin 12,
      ...
      tropicalComponentAQuotientIntermediate8 0 := by
