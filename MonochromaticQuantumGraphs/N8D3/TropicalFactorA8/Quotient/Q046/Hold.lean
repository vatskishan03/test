import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Quotient.Q046.Certificate
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Source.S078.Hold
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Source.S081.Hold

/-!
# Component-A quotient row 46: exactly two source holds
-/
...
/-- Public quotient-hold API for row 46. -/
theorem tropicalComponentAQuotientRelation8_046_hold
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W)
    (hEq : EqSystemN 8 3 W) (hChars : TropicalComponentACharacters8 W) :
    TropicalFactorA8.Internal.Quotient046.relation.Holds (tropicalSupportWeight8 W) :=
  TropicalFactorA8.Internal.Quotient046.hold hSupport hEq hChars
