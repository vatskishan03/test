...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Source.S011.Hold
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Source.S050.Hold

/-!
# Component-A quotient row 11: exactly two source holds
-/
...
theorem hold
  ...
  have hsources : ∀ s : Fin 2,
    ...
    · simpa [shiftedSources] using
        TropicalFactorA8.Internal.Source011.hold hSupport hEq hChars
    · simpa [shiftedSources] using
...
/-- Public quotient-hold API for row 11. -/
theorem tropicalComponentAQuotientRelation8_011_hold
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W)
    (hEq : EqSystemN 8 3 W) (hChars : TropicalComponentACharacters8 W) :
    TropicalFactorA8.Internal.Quotient011.relation.Holds (tropicalSupportWeight8 W) :=
  TropicalFactorA8.Internal.Quotient011.hold hSupport hEq hChars
