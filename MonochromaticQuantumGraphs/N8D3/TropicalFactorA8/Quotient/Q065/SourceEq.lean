import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Quotient.Q065.Uses

/-!
# Component-A quotient row 65: intermediate source equality
-/
...
theorem source_eq :
    (∑ k : Fin 12,
      ...
      tropicalComponentAQuotientIntermediate8 65 := by
