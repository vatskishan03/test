import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Quotient.Q015.Uses

/-!
# Component-A quotient row 15: intermediate source equality
-/
...
theorem source_eq :
    (∑ k : Fin 12,
      ...
      tropicalComponentAQuotientIntermediate8 15 := by
