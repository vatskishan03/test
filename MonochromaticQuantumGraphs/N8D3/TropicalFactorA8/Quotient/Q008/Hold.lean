...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Source.S006.Hold
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Source.S028.Hold

/-!
# Component-A quotient row 8: exactly two source holds
-/
...
theorem hold
  ...
  have hsources : ∀ s : Fin 2,
    ...
    · simpa [shiftedSources] using
        TropicalFactorA8.Internal.Source006.hold hSupport hEq hChars
    · simpa [shiftedSources] using
...
/-- Public quotient-hold API for row 8. -/
theorem tropicalComponentAQuotientRelation8_008_hold
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W)
    (hEq : EqSystemN 8 3 W) (hChars : TropicalComponentACharacters8 W) :
    TropicalFactorA8.Internal.Quotient008.relation.Holds (tropicalSupportWeight8 W) :=
  TropicalFactorA8.Internal.Quotient008.hold hSupport hEq hChars
