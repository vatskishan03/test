import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Quotient.Q003.Data

/-!
# Component-A quotient row 3: shifted-source equality
-/
...
theorem shifted_eq :
  ...
  have h11 : (((0 : LaurentExponent (Fin 144)) + (Pi.single (7 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (138 : Fin 144) (1 : ℤ))) := by
    (ext x; simp [Pi.single_apply] <;> split_ifs <;> omega)
  simp [shiftedUse, shiftedSources, TropicalFactorA8.Internal.Source002.reduced,
    TropicalFactorA8.Internal.Source008.reduced, intermediate,
    Fin.sum_univ_succ,
