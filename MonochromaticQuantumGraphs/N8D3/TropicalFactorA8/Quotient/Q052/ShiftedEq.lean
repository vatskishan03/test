...
/-!
# Component-A quotient row 52: shifted-source equality
-/
...
theorem shifted_eq :
  ...
  have h01 : (((Pi.single (15 : Fin 144) (-1 : ℤ) +
        ...
        Pi.single (130 : Fin 144) (1 : ℤ)) : LaurentExponent (Fin 144)) = (Pi.single (7 : Fin 144) (1 : ℤ) +
        Pi.single (17 : Fin 144) (1 : ℤ) +
        Pi.single (48 : Fin 144) (1 : ℤ) +
        Pi.single (88 : Fin 144) (1 : ℤ) +
  ...
  have h11 : (((0 : LaurentExponent (Fin 144)) + (Pi.single (6 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (139 : Fin 144) (1 : ℤ))) := by
    (ext x; simp [Pi.single_apply] <;> split_ifs <;> omega)
  simp [shiftedUse, shiftedSources, TropicalFactorA8.Internal.Source088.reduced,
    TropicalFactorA8.Internal.Source091.reduced, intermediate,
    Fin.sum_univ_succ,
