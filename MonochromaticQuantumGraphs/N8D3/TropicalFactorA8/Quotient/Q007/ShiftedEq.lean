...
/-!
# Component-A quotient row 7: shifted-source equality
-/
...
theorem shifted_eq :
  ...
  have h11 : (((0 : LaurentExponent (Fin 144)) + (Pi.single (7 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (141 : Fin 144) (1 : ℤ))) := by
    (ext x; simp [Pi.single_apply]; split_ifs <;> omega)
  simp [shiftedUse, shiftedSources, TropicalFactorA8.Internal.Source005.reduced,
    TropicalFactorA8.Internal.Source047.reduced, intermediate,
    Fin.sum_univ_succ,
