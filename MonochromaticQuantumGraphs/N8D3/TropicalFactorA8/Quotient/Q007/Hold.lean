...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Source.S005.Hold
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Source.S047.Hold

/-!
# Component-A quotient row 7: exactly two source holds
-/
...
theorem hold
  ...
  have hsources : ∀ s : Fin 2,
    ...
    · simpa [shiftedSources] using
        TropicalFactorA8.Internal.Source005.hold hSupport hEq hChars
    · simpa [shiftedSources] using
...
/-- Public quotient-hold API for row 7. -/
theorem tropicalComponentAQuotientRelation8_007_hold
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W)
    (hEq : EqSystemN 8 3 W) (hChars : TropicalComponentACharacters8 W) :
    TropicalFactorA8.Internal.Quotient007.relation.Holds (tropicalSupportWeight8 W) :=
  TropicalFactorA8.Internal.Quotient007.hold hSupport hEq hChars
