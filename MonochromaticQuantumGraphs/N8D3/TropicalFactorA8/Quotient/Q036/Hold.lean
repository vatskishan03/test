...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Source.S038.Hold
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Source.S040.Hold

/-!
# Component-A quotient row 36: exactly two source holds
-/
...
/-- Public quotient-hold API for row 36. -/
theorem tropicalComponentAQuotientRelation8_036_hold
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W)
    (hEq : EqSystemN 8 3 W) (hChars : TropicalComponentACharacters8 W) :
    TropicalFactorA8.Internal.Quotient036.relation.Holds (tropicalSupportWeight8 W) :=
  TropicalFactorA8.Internal.Quotient036.hold hSupport hEq hChars
