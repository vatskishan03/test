import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Quotient.Q006.Data

/-!
# Component-A quotient row 6: shifted-source equality
-/
...
theorem shifted_eq :
  ...
  have h02 : (((Pi.single (58 : Fin 144) (-1 : ℤ) +
        ...
        Pi.single (126 : Fin 144) (1 : ℤ)) : LaurentExponent (Fin 144)) = (Pi.single (7 : Fin 144) (1 : ℤ) +
        Pi.single (64 : Fin 144) (1 : ℤ) +
        Pi.single (87 : Fin 144) (1 : ℤ) +
        Pi.single (108 : Fin 144) (1 : ℤ) +
  ...
  have h11 : (((0 : LaurentExponent (Fin 144)) + (Pi.single (7 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (138 : Fin 144) (1 : ℤ))) := by
    (ext x; simp [Pi.single_apply]; split_ifs <;> omega)
  simp [shiftedUse, shiftedSources, TropicalFactorA8.Internal.Source004.reduced,
    TropicalFactorA8.Internal.Source010.reduced, intermediate,
    Fin.sum_univ_succ,
