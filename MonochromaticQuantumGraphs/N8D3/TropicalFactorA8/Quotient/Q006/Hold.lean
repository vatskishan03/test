...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Source.S010.Hold

/-!
# Component-A quotient row 6: exactly two source holds
-/
...
/-- Public quotient-hold API for row 6. -/
theorem tropicalComponentAQuotientRelation8_006_hold
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W)
    (hEq : EqSystemN 8 3 W) (hChars : TropicalComponentACharacters8 W) :
    TropicalFactorA8.Internal.Quotient006.relation.Holds (tropicalSupportWeight8 W) :=
  TropicalFactorA8.Internal.Quotient006.hold hSupport hEq hChars
