...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Source.S074.Hold

/-!
# Component-A quotient row 43: exactly two source holds
-/
...
/-- Public quotient-hold API for row 43. -/
theorem tropicalComponentAQuotientRelation8_043_hold
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W)
    (hEq : EqSystemN 8 3 W) (hChars : TropicalComponentACharacters8 W) :
    TropicalFactorA8.Internal.Quotient043.relation.Holds (tropicalSupportWeight8 W) :=
  TropicalFactorA8.Internal.Quotient043.hold hSupport hEq hChars
