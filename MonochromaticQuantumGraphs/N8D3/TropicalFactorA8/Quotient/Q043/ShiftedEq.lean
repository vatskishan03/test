import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Quotient.Q043.Data

/-!
# Component-A quotient row 43: shifted-source equality
-/
...
theorem shifted_eq :
  ...
  have h01 : (((Pi.single (59 : Fin 144) (-1 : ℤ) +
        ...
        Pi.single (123 : Fin 144) (1 : ℤ)) : LaurentExponent (Fin 144)) = (Pi.single (26 : Fin 144) (1 : ℤ) +
        Pi.single (48 : Fin 144) (1 : ℤ) +
        Pi.single (59 : Fin 144) (-1 : ℤ) +
        Pi.single (65 : Fin 144) (1 : ℤ) +
        Pi.single (69 : Fin 144) (1 : ℤ) +
  ...
  have h11 : (((0 : LaurentExponent (Fin 144)) + (Pi.single (6 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (139 : Fin 144) (1 : ℤ))) := by
    (ext x; simp [Pi.single_apply] <;> split_ifs <;> omega)
  simp [shiftedUse, shiftedSources, TropicalFactorA8.Internal.Source069.reduced,
    TropicalFactorA8.Internal.Source074.reduced, intermediate,
    Fin.sum_univ_succ,
