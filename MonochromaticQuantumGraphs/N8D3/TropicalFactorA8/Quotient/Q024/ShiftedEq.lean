...
/-!
# Component-A quotient row 24: shifted-source equality
-/
...
theorem shifted_eq :
  ...
  have h02 : (((Pi.single (58 : Fin 144) (-1 : ℤ) +
        ...
        Pi.single (129 : Fin 144) (1 : ℤ)) : LaurentExponent (Fin 144)) = (Pi.single (7 : Fin 144) (1 : ℤ) +
        Pi.single (64 : Fin 144) (1 : ℤ) +
        Pi.single (86 : Fin 144) (1 : ℤ) +
        Pi.single (108 : Fin 144) (1 : ℤ) +
  ...
  have h11 : (((0 : LaurentExponent (Fin 144)) + (Pi.single (7 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (138 : Fin 144) (1 : ℤ))) := by
    abel
  simp [shiftedUse, shiftedSources, TropicalFactorA8.Internal.Source024.reduced,
    TropicalFactorA8.Internal.Source029.reduced, intermediate,
    Fin.sum_univ_succ,
