import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Quotient.Q063.Uses

/-!
# Component-A quotient row 63: intermediate source equality
-/
...
theorem source_eq :
    (∑ k : Fin 12,
      ...
      tropicalComponentAQuotientIntermediate8 63 := by
