...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Source.S058.Hold

/-!
# Component-A quotient row 23: exactly two source holds
-/
...
/-- Public quotient-hold API for row 23. -/
theorem tropicalComponentAQuotientRelation8_023_hold
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W)
    (hEq : EqSystemN 8 3 W) (hChars : TropicalComponentACharacters8 W) :
    TropicalFactorA8.Internal.Quotient023.relation.Holds (tropicalSupportWeight8 W) :=
  TropicalFactorA8.Internal.Quotient023.hold hSupport hEq hChars
