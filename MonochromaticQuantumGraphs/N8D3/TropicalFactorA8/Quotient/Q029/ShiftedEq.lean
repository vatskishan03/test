import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Quotient.Q029.Data

/-!
# Component-A quotient row 29: shifted-source equality
-/
...
theorem shifted_eq :
  ...
  have h00 : (((Pi.single (48 : Fin 144) (-1 : ℤ) +
        ...
        Pi.single (119 : Fin 144) (1 : ℤ)) : LaurentExponent (Fin 144)) = (Pi.single (26 : Fin 144) (1 : ℤ) +
  ...
  have h11 : (((0 : LaurentExponent (Fin 144)) + (Pi.single (7 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (141 : Fin 144) (1 : ℤ))) := by
    (ext x; simp [Pi.single_apply] <;> split_ifs <;> omega)
  simp [shiftedUse, shiftedSources, TropicalFactorA8.Internal.Source030.reduced,
    TropicalFactorA8.Internal.Source062.reduced, intermediate,
    Fin.sum_univ_succ,
