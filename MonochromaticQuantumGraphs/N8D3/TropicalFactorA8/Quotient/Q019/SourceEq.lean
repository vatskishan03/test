import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Quotient.Q019.Uses

/-!
# Component-A quotient row 19: intermediate source equality
-/
...
theorem source_eq :
    (∑ k : Fin 12,
      ...
      tropicalComponentAQuotientIntermediate8 19 := by
