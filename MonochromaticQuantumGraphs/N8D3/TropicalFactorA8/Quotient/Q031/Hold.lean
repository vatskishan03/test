...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Source.S064.Hold

/-!
# Component-A quotient row 31: exactly two source holds
-/
...
theorem hold
  ...
  have hsources : ∀ s : Fin 2,
    ...
    · simpa [shiftedSources] using
        TropicalFactorA8.Internal.Source064.hold hSupport hEq hChars
  have hintermediate :
...
/-- Public quotient-hold API for row 31. -/
theorem tropicalComponentAQuotientRelation8_031_hold
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W)
    (hEq : EqSystemN 8 3 W) (hChars : TropicalComponentACharacters8 W) :
    TropicalFactorA8.Internal.Quotient031.relation.Holds (tropicalSupportWeight8 W) :=
  TropicalFactorA8.Internal.Quotient031.hold hSupport hEq hChars
