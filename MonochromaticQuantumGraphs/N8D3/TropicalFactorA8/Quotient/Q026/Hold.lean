...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Source.S060.Hold

/-!
# Component-A quotient row 26: exactly two source holds
-/
...
/-- Public quotient-hold API for row 26. -/
theorem tropicalComponentAQuotientRelation8_026_hold
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W)
    (hEq : EqSystemN 8 3 W) (hChars : TropicalComponentACharacters8 W) :
    TropicalFactorA8.Internal.Quotient026.relation.Holds (tropicalSupportWeight8 W) :=
  TropicalFactorA8.Internal.Quotient026.hold hSupport hEq hChars
