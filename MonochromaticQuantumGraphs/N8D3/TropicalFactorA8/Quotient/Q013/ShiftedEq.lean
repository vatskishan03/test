import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Quotient.Q013.Data

/-!
# Component-A quotient row 13: shifted-source equality
-/
...
theorem shifted_eq :
  ...
  have h00 : (((Pi.single (86 : Fin 144) (-1 : ℤ) +
        Pi.single (89 : Fin 144) (1 : ℤ)) + (Pi.single (7 : Fin 144) (1 : ℤ) +
  ...
  simp [shiftedUse, shiftedSources, TropicalFactorA8.Internal.Source012.reduced,
    TropicalFactorA8.Internal.Source020.reduced, intermediate,
    Fin.sum_univ_succ,
