...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Source.S107.Hold

/-!
# Component-A quotient row 64: exactly two source holds
-/
...
/-- Public quotient-hold API for row 64. -/
theorem tropicalComponentAQuotientRelation8_064_hold
    {W : WeightsN 8 3 ℂ} (hSupport : TropicalExactSupport8 W)
    (hEq : EqSystemN 8 3 W) (hChars : TropicalComponentACharacters8 W) :
    TropicalFactorA8.Internal.Quotient064.relation.Holds (tropicalSupportWeight8 W) :=
  TropicalFactorA8.Internal.Quotient064.hold hSupport hEq hChars
