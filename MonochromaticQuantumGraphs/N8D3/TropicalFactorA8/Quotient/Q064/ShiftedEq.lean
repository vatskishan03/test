import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Quotient.Q064.Data

/-!
# Component-A quotient row 64: shifted-source equality
-/
...
theorem shifted_eq :
  ...
  have h02 : (((Pi.single (59 : Fin 144) (-1 : ℤ) +
        ...
        Pi.single (133 : Fin 144) (1 : ℤ)) : LaurentExponent (Fin 144)) = (Pi.single (6 : Fin 144) (1 : ℤ) +
        Pi.single (65 : Fin 144) (1 : ℤ) +
        Pi.single (90 : Fin 144) (1 : ℤ) +
        Pi.single (108 : Fin 144) (1 : ℤ) +
  ...
  have h11 : (((0 : LaurentExponent (Fin 144)) + (Pi.single (6 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (139 : Fin 144) (1 : ℤ))) := by
    abel
  simp [shiftedUse, shiftedSources, TropicalFactorA8.Internal.Source104.reduced,
    TropicalFactorA8.Internal.Source107.reduced, intermediate,
    Fin.sum_univ_succ,
