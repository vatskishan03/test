import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Quotient.Q033.Data

/-!
# Component-A quotient row 33: shifted-source equality
-/
...
theorem shifted_eq :
  ...
  have h11 : (((0 : LaurentExponent (Fin 144)) + (Pi.single (1 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (141 : Fin 144) (1 : ℤ))) := by
    abel
  simp [shiftedUse, shiftedSources, TropicalFactorA8.Internal.Source034.reduced,
    TropicalFactorA8.Internal.Source065.reduced, intermediate,
    Fin.sum_univ_succ,
