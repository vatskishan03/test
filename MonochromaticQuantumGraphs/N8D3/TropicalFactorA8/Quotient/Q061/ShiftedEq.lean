import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Quotient.Q061.Data
...
theorem shifted_eq :
  ...
  have h11 : (((0 : LaurentExponent (Fin 144)) + (Pi.single (6 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (139 : Fin 144) (1 : ℤ))) := by
    (ext x; simp [Pi.single_apply] <;> split_ifs <;> omega)
  simp [shiftedUse, shiftedSources, TropicalFactorA8.Internal.Source102.reduced,
    TropicalFactorA8.Internal.Source105.reduced, intermediate,
    Fin.sum_univ_succ,
