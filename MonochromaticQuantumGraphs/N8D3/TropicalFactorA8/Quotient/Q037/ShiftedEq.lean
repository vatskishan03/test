...
/-!
# Component-A quotient row 37: shifted-source equality
-/
...
theorem shifted_eq :
  ...
  have h00 : (((Pi.single (58 : Fin 144) (-1 : ℤ) +
        Pi.single (64 : Fin 144) (1 : ℤ)) + (Pi.single (19 : Fin 144) (1 : ℤ) +
  ...
  have h01 : (((Pi.single (58 : Fin 144) (-1 : ℤ) +
        ...
        Pi.single (122 : Fin 144) (1 : ℤ)) : LaurentExponent (Fin 144)) = (Pi.single (19 : Fin 144) (1 : ℤ) +
        Pi.single (51 : Fin 144) (1 : ℤ) +
        Pi.single (58 : Fin 144) (-1 : ℤ) +
        Pi.single (64 : Fin 144) (1 : ℤ) +
        Pi.single (71 : Fin 144) (1 : ℤ) +
  ...
  have h02 : (((Pi.single (58 : Fin 144) (-1 : ℤ) +
        Pi.single (64 : Fin 144) (1 : ℤ)) + (Pi.single (1 : Fin 144) (1 : ℤ) +
        Pi.single (58 : Fin 144) (1 : ℤ) +
        Pi.single (87 : Fin 144) (1 : ℤ) +
        Pi.single (111 : Fin 144) (1 : ℤ) +
        Pi.single (132 : Fin 144) (1 : ℤ)) : LaurentExponent (Fin 144)) = (Pi.single (1 : Fin 144) (1 : ℤ) +
        Pi.single (64 : Fin 144) (1 : ℤ) +
        Pi.single (87 : Fin 144) (1 : ℤ) +
        Pi.single (111 : Fin 144) (1 : ℤ) +
  ...
  have h05 : (((Pi.single (58 : Fin 144) (-1 : ℤ) +
        ...
        Pi.single (138 : Fin 144) (1 : ℤ))) := by
    (ext x; simp [Pi.single_apply]; split_ifs <;> omega)
  have h06 : (((0 : LaurentExponent (Fin 144)) + (Pi.single (19 : Fin 144) (1 : ℤ) +
        Pi.single (51 : Fin 144) (1 : ℤ) +
  ...
  have h11 : (((0 : LaurentExponent (Fin 144)) + (Pi.single (1 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (138 : Fin 144) (1 : ℤ))) := by
    (ext x; simp [Pi.single_apply]; split_ifs <;> omega)
  simp [shiftedUse, shiftedSources, TropicalFactorA8.Internal.Source041.reduced,
    TropicalFactorA8.Internal.Source042.reduced, intermediate,
    Fin.sum_univ_succ,
