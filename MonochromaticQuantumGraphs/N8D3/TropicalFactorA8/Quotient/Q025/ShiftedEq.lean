import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Quotient.Q025.Data

/-!
# Component-A quotient row 25: shifted-source equality
-/
...
theorem shifted_eq :
  ...
  have h11 : (((0 : LaurentExponent (Fin 144)) + (Pi.single (7 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (141 : Fin 144) (1 : ℤ))) := by
    (ext x; simp [Pi.single_apply]; split_ifs <;> omega)
  simp [shiftedUse, shiftedSources, TropicalFactorA8.Internal.Source025.reduced,
    TropicalFactorA8.Internal.Source059.reduced, intermediate,
    Fin.sum_univ_succ,
