import MonochromaticQuantumGraphs.N8D3.TropicalFactorA8.Quotient.Q035.Data

/-!
# Component-A quotient row 35: shifted-source equality
-/
...
theorem shifted_eq :
  ...
  have h01 : (((Pi.single (58 : Fin 144) (-1 : ℤ) +
        ...
        Pi.single (119 : Fin 144) (1 : ℤ)) : LaurentExponent (Fin 144)) = (Pi.single (25 : Fin 144) (1 : ℤ) +
        Pi.single (51 : Fin 144) (1 : ℤ) +
        Pi.single (58 : Fin 144) (-1 : ℤ) +
        Pi.single (64 : Fin 144) (1 : ℤ) +
        Pi.single (71 : Fin 144) (1 : ℤ) +
  ...
  have h11 : (((0 : LaurentExponent (Fin 144)) + (Pi.single (7 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (138 : Fin 144) (1 : ℤ))) := by
    (ext x; simp [Pi.single_apply]; split_ifs <;> omega)
  simp [shiftedUse, shiftedSources, TropicalFactorA8.Internal.Source037.reduced,
    TropicalFactorA8.Internal.Source039.reduced, intermediate,
    Fin.sum_univ_succ,
