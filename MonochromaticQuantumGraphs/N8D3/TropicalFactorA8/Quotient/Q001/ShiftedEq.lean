...
/-!
# Component-A quotient row 1: shifted-source equality
-/
...
theorem shifted_eq :
  ...
  have h00 : (((Pi.single (48 : Fin 144) (-1 : ℤ) +
        ...
        Pi.single (116 : Fin 144) (1 : ℤ)) : LaurentExponent (Fin 144)) = (Pi.single (26 : Fin 144) (1 : ℤ) +
  ...
  have h11 : (((0 : LaurentExponent (Fin 144)) + (Pi.single (7 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (141 : Fin 144) (1 : ℤ))) := by
    abel
  simp [shiftedUse, shiftedSources, TropicalFactorA8.Internal.Source001.reduced,
    TropicalFactorA8.Internal.Source043.reduced, intermediate,
    Fin.sum_univ_succ,
