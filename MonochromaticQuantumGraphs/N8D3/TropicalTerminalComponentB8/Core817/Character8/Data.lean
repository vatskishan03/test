...
/-! Explicit termwise uses for `terminalBCore817Character8`. -/
...
def terminalBCore817Character8ReductionUse8 :
    Fin 6 → CharacterReductionUse (fun i : Fin 8 ↦ terminalBCore817Basis8 ⟨i.val, by omega⟩) :=
![
  { coefficient := (1 : ℤ)
