...
/-! Explicit termwise uses for `terminalBCore817Character9`. -/
...
def terminalBCore817Character9ReductionUse8 :
    Fin 6 → CharacterReductionUse (fun i : Fin 9 ↦ terminalBCore817Basis8 ⟨i.val, by omega⟩) :=
![
  { coefficient := (1 : ℤ)
