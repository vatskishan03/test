...
/-! Explicit termwise uses for `terminalBCore817Character14`. -/
...
def terminalBCore817Character14ReductionUse8 :
    Fin 4 → CharacterReductionUse (fun i : Fin 14 ↦ terminalBCore817Basis8 ⟨i.val, by omega⟩) :=
![
  { coefficient := (1 : ℤ)
