...
/-! Explicit termwise uses for `terminalBCore817Character11`. -/
...
def terminalBCore817Character11ReductionUse8 :
    Fin 6 → CharacterReductionUse (fun i : Fin 11 ↦ terminalBCore817Basis8 ⟨i.val, by omega⟩) :=
![
  { coefficient := (1 : ℤ)
