...
/-! Explicit termwise uses for `terminalBCore817Character10`. -/
...
def terminalBCore817Character10ReductionUse8 :
    Fin 6 → CharacterReductionUse (fun i : Fin 10 ↦ terminalBCore817Basis8 ⟨i.val, by omega⟩) :=
![
  { coefficient := (1 : ℤ)
