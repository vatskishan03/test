...
/-! Explicit termwise uses for `terminalBClass19NestedLeft`. -/
...
def terminalBClass19NestedLeftReductionUse8 :
    Fin 9 → CharacterReductionUse terminalBClass19Basis8 :=
![
  { coefficient := (1 : ℤ)
  ...
  { coefficient := (1 : ℤ)
      sourceExponent := (Pi.single (27 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (58 : Fin 144) (1 : ℤ) +
        Pi.single (138 : Fin 144) (1 : ℤ))
      targetExponent := (Pi.single (27 : Fin 144) (1 : ℤ) +
        Pi.single (38 : Fin 144) (1 : ℤ) +
        Pi.single (58 : Fin 144) (1 : ℤ) +
        Pi.single (138 : Fin 144) (1 : ℤ))
      reduction := { signExponent := (0 : ℤ)
