...
/-! Explicit termwise uses for `terminalBClass19Character4`. -/
...
def terminalBClass19Character4ReductionUse8 :
    Fin 6 → CharacterReductionUse (fun i : Fin 4 ↦ terminalBClass19Basis8 ⟨i.val, by omega⟩) :=
![
  { coefficient := (1 : ℤ)
