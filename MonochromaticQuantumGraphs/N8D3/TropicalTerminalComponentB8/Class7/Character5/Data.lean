...
/-! Explicit termwise uses for `terminalBClass7Character5`. -/
...
def terminalBClass7Character5ReductionUse8 :
    Fin 6 → CharacterReductionUse (fun i : Fin 5 ↦ terminalBClass7Basis8 ⟨i.val, by omega⟩) :=
![
  { coefficient := (1 : ℤ)
