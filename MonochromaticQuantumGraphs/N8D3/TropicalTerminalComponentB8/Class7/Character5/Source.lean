...
/-! Sparse source equality for `terminalBClass7Character5`. -/
...
theorem terminalBClass7Character5SourceExplicit8 :
    tropicalOverlapRelation8 45 = (Finsupp.single (Pi.single (19 : Fin 144) (1 : ℤ) +
  ...
  change tropicalOverlapRelation8Row45 =
    (Finsupp.single (Pi.single (19 : Fin 144) (1 : ℤ) +
        Pi.single (52 : Fin 144) (1 : ℤ) +
        Pi.single (69 : Fin 144) (1 : ℤ) +
        Pi.single (122 : Fin 144) (1 : ℤ) +
  ...
  unfold tropicalOverlapRelation8Row45
  unfold tropicalOverlapDegreeFiveExponent8
  simp only [Finsupp.single_neg] <;> abel

theorem terminalBClass7Character5SourceEq8 :
    (∑ k : Fin 6,
      Finsupp.single (terminalBClass7Character5ReductionUse8 k).sourceExponent
        (terminalBClass7Character5ReductionUse8 k).coefficient) = tropicalOverlapRelation8 45 := by
  rw [terminalBClass7Character5SourceExplicit8]
  simp only [Fin.sum_univ_succ, terminalBClass7Character5ReductionUse8] <;> abel
