...
/-! Explicit termwise uses for `terminalBClass7Character3`. -/
...
def terminalBClass7Character3ReductionUse8 :
    Fin 6 → CharacterReductionUse (fun i : Fin 3 ↦ terminalBClass7Basis8 ⟨i.val, by omega⟩) :=
![
  { coefficient := (1 : ℤ)
