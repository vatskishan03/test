...
/-! Shared nested-face data for Class7. -/
...
def terminalBClass7NestedOmittedExponent8 : LaurentExponent (Fin 144) :=
  (Pi.single (31 : Fin 144) (1 : ℤ) +
        Pi.single (41 : Fin 144) (1 : ℤ) +
        Pi.single (57 : Fin 144) (1 : ℤ) +
        Pi.single (116 : Fin 144) (1 : ℤ))

def terminalBClass7NestedFace8 : LaurentPolynomial (Fin 144) :=
...
def terminalBClass7NestedRightReduced8 : LaurentPolynomial (Fin 144) :=
  (Finsupp.single (Pi.single (28 : Fin 144) (1 : ℤ) +
...
def terminalBClass7NestedFaceShift8 : LaurentExponent (Fin 144) :=
  (Pi.single (51 : Fin 144) (-1 : ℤ) +
        Pi.single (52 : Fin 144) (1 : ℤ))
