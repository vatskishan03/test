...
/-! Explicit termwise uses for `terminalBClass14Character3`. -/
...
def terminalBClass14Character3ReductionUse8 :
    Fin 6 → CharacterReductionUse (fun i : Fin 3 ↦ terminalBClass14Basis8 ⟨i.val, by omega⟩) :=
![
  { coefficient := (1 : ℤ)
