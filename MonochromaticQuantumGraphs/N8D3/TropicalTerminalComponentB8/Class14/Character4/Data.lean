...
/-! Explicit termwise uses for `terminalBClass14Character4`. -/
...
def terminalBClass14Character4ReductionUse8 :
    Fin 6 → CharacterReductionUse (fun i : Fin 4 ↦ terminalBClass14Basis8 ⟨i.val, by omega⟩) :=
![
  { coefficient := (1 : ℤ)
