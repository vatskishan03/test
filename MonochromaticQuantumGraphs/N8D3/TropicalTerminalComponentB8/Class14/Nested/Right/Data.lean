import MonochromaticQuantumGraphs.N8D3.TropicalTerminalComponentB8.Class14.Nested.Data

/-! Explicit termwise uses for `terminalBClass14NestedRight`. -/
...
def terminalBClass14NestedRightReductionUse8 :
    Fin 6 → CharacterReductionUse terminalBClass14Basis8 :=
![
  { coefficient := (1 : ℤ)
