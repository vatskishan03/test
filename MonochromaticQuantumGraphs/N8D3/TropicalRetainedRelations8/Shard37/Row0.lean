...
/-! Kernel replay for first-overlap row 185. -/
...
/-- Kernel replay of the six shifted `B_i` exponents in row 185. -/
...
private theorem tropicalOverlapRelation8_sourceCombination_row185 :
