...
/-! Kernel replay for first-overlap row 122. -/
...
set_option maxHeartbeats 10000000 in
/-- Kernel replay of the six shifted `B_j` exponents in row 122. -/
...
private theorem tropicalOverlapRelation8_sourceCombination_row122 :
