...
/-! Kernel replay for first-overlap row 263. -/
...
set_option maxHeartbeats 10000000 in
/-- Kernel replay of the six shifted `B_j` exponents in row 263. -/
...
private theorem tropicalOverlapRelation8_sourceCombination_row263 :
