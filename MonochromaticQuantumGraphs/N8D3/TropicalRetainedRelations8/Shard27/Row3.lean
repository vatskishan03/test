...
/-! Kernel replay for first-overlap row 138. -/
...
/-- Kernel replay of the six shifted `B_i` exponents in row 138. -/
...
private theorem tropicalOverlapRelation8_sourceCombination_row138 :
