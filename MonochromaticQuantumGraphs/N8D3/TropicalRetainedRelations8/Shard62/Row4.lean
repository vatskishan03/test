...
/-! Kernel replay for first-overlap row 314. -/
...
/-- Kernel replay of the six shifted `B_i` exponents in row 314. -/
...
private theorem tropicalOverlapRelation8_sourceCombination_row314 :
