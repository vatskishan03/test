...
/-! Kernel replay for first-overlap row 150. -/
...
/-- Kernel replay of the six shifted `B_i` exponents in row 150. -/
...
set_option maxHeartbeats 10000000 in
/-- Kernel replay of the six shifted `B_j` exponents in row 150. -/
...
private theorem tropicalOverlapRelation8_sourceCombination_row150 :
