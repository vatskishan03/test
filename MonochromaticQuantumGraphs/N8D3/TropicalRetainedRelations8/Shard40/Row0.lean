...
/-! Kernel replay for first-overlap row 200. -/
...
/-- Kernel replay of the six shifted `B_i` exponents in row 200. -/
...
private theorem tropicalOverlapRelation8_sourceCombination_row200 :
