...
/-! Kernel replay for first-overlap row 105. -/
...
set_option maxHeartbeats 10000000 in
/-- Kernel replay of the six shifted `B_j` exponents in row 105. -/
...
private theorem tropicalOverlapRelation8_sourceCombination_row105 :
