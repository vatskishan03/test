...
/-! Kernel replay for first-overlap row 100. -/
...
/-- Kernel replay of the six shifted `B_i` exponents in row 100. -/
...
set_option maxHeartbeats 10000000 in
/-- Kernel replay of the six shifted `B_j` exponents in row 100. -/
...
private theorem tropicalOverlapRelation8_sourceCombination_row100 :
