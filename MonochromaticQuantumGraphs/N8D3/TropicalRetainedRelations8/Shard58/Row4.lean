...
/-! Kernel replay for first-overlap row 294. -/
...
/-- Exact two-base-source provenance for overlap row 294. -/
def tropicalOverlapProvenance8Row294 : TropicalOverlapProvenance8 :=
  { epsilon := -1, sourceI := 144, coordinateB := 7, sourceJ := 147, coordinateA := 0 }

/-- The explicit sparse target polynomial in overlap row 294. -/
def tropicalOverlapRelation8Row294 : LaurentPolynomial (Fin 144) :=
  Finsupp.single
...
def tropicalOverlapSourceIExponent8Row294 :
...
def tropicalOverlapSourceJExponent8Row294 :
    Fin 6 → LaurentExponent (Fin 144) :=
![
  tropicalOverlapDegreeFiveExponent8 0 7 59 103 139,
  tropicalOverlapDegreeFiveExponent8 0 7 59 111 133,
...
/-- Kernel replay of the six shifted `B_i` exponents in row 294. -/
...
set_option maxHeartbeats 10000000 in
/-- Kernel replay of the six shifted `B_j` exponents in row 294. -/
...
def tropicalOverlapSourceCombination8Row294 :
    LaurentPolynomial (Fin 144) :=
  tropicalOverlapProvenance8Row294.epsilon •
    ((∑ j : Fin 6,
        Finsupp.single (tropicalOverlapSourceIExponent8Row294 j) 1) -
      ∑ j : Fin 6,
        Finsupp.single (tropicalOverlapSourceJExponent8Row294 j) 1)

/-- Coefficientwise cancellation of the three common translated faces. -/
private theorem tropicalOverlapRelation8_sourceCombination_row294 :
...
row 294. -/
theorem tropicalOverlapRelation8_provenance_row294 :
    tropicalOverlapRelation8Row294 =
      tropicalOverlapProvenancePolynomial8
        tropicalOverlapProvenance8Row294 := by
  rw [tropicalOverlapRelation8_sourceCombination_row294]
  unfold tropicalOverlapSourceCombination8Row294
  unfold tropicalOverlapProvenancePolynomial8
  rw [tropicalOverlapTranslateBaseRelation8,
    tropicalOverlapTranslateBaseRelation8]
  simp_rw [tropicalOverlapSourceIExponent8_replay_row294,
    tropicalOverlapSourceJExponent8_replay_row294]
