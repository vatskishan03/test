...
/-! Kernel replay for first-overlap row 181. -/
...
set_option maxHeartbeats 10000000 in
/-- Kernel replay of the six shifted `B_j` exponents in row 181. -/
...
private theorem tropicalOverlapRelation8_sourceCombination_row181 :
