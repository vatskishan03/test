...
/-! Kernel replay for first-overlap row 345. -/
...
/-- Kernel replay of the six shifted `B_i` exponents in row 345. -/
...
set_option maxHeartbeats 10000000 in
/-- Kernel replay of the six shifted `B_j` exponents in row 345. -/
...
private theorem tropicalOverlapRelation8_sourceCombination_row345 :
