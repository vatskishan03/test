...
/-! Kernel replay for first-overlap row 68. -/
...
/-- Kernel replay of the six shifted `B_i` exponents in row 68. -/
...
private theorem tropicalOverlapRelation8_sourceCombination_row68 :
