...
/-! Kernel replay for first-overlap row 241. -/
...
/-- Kernel replay of the six shifted `B_i` exponents in row 241. -/
...
set_option maxHeartbeats 10000000 in
/-- Kernel replay of the six shifted `B_j` exponents in row 241. -/
...
private theorem tropicalOverlapRelation8_sourceCombination_row241 :
