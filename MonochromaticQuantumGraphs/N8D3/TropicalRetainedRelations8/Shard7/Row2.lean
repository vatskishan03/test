...
/-! Kernel replay for first-overlap row 37. -/
...
/-- Kernel replay of the six shifted `B_i` exponents in row 37. -/
...
set_option maxHeartbeats 10000000 in
/-- Kernel replay of the six shifted `B_j` exponents in row 37. -/
...
private theorem tropicalOverlapRelation8_sourceCombination_row37 :
