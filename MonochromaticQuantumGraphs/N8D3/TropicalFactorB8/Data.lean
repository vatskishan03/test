...
/-- Adapt a three-entry coefficient vector to the two Component-B rows plus
...
/-- The retained row behind each of the 147 unique quotient source reductions. -/
def tropicalComponentBQuotientSourceIndex8 : Fin 147 → Fin 560 :=
![
  100,
  101,
  102,
...
def tropicalComponentBQuotientReducedSource8 :
    Fin 147 → LaurentPolynomial (Fin 144) :=
![
...
def tropicalComponentBQuotientIntermediate8 :
    Fin 88 → LaurentPolynomial (Fin 144) :=
![
  (Finsupp.single (Pi.single (15 : Fin 144) (1 : ℤ) +
        Pi.single (39 : Fin 144) (1 : ℤ) +
        Pi.single (88 : Fin 144) (1 : ℤ) +
...
/-- The exact 88 normalized Component-B quotient relations. -/
...
/-- The exact 49 raw signed-character factors. -/
def tropicalComponentBRawFactor8 :
    Fin 49 → SignedCharacterRow (Fin 144) :=
![
...
/-- The exact 59 unordered raw-factor edges, in certificate order. -/
...
def tropicalComponentBRawFactorEdgeQuotient8 : Fin 59 → Fin 88 :=
![
  63,
  76,
  58,
...
/-- Exact symmetric adjacency generated by the 59 certified raw edges. -/
...
def tropicalComponentBRawFactorClass8 : Fin 49 → Fin 23 :=
![
  0,
  1,
  1,
...
/-- Exact member set of every one of the 23 false-twin classes. -/
def tropicalComponentBClassMembers8 : Fin 23 → Finset (Fin 49) :=
![
  {0},
  {1, 2},
  {3},
