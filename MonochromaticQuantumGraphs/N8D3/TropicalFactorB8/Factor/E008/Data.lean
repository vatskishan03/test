...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.Vertex.V047

/-!
# Row-local data for Component-B factor edge 8
-/
...
def sourceRelation : LaurentPolynomial (Fin 144) :=
  TropicalFactorB8.Internal.Quotient061.relation
...
def rightFactor : SignedCharacterRow (Fin 144) :=
  TropicalFactorB8.Internal.Vertex047.row
