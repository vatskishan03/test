import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E008.Uses

/-!
# Factor edge 8 sparse translated-product equality
-/
...
/-- Sparse translated-product equality for factor edge 8. -/
theorem target_eq :
    (∑ k : Fin 4,
