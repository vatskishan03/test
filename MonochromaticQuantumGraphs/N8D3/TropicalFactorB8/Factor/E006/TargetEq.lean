import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E006.Uses

/-!
# Factor edge 6 sparse translated-product equality
-/
...
/-- Sparse translated-product equality for factor edge 6. -/
theorem target_eq :
    (∑ k : Fin 4,
