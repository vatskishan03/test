...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.Vertex.V043

/-!
# Row-local data for Component-B factor edge 6
-/
...
def sourceRelation : LaurentPolynomial (Fin 144) :=
  TropicalFactorB8.Internal.Quotient087.relation
...
def rightFactor : SignedCharacterRow (Fin 144) :=
  TropicalFactorB8.Internal.Vertex043.row
