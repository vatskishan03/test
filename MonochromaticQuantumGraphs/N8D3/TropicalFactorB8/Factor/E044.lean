...
/-!
# Component-B raw factor edge 44
...
private def tropicalComponentBFactorEdge044Monomial008 :
...
private def tropicalComponentBFactorEdge044Monomial018 :
    MonomialReductionCertificate tropicalComponentBCharacter8
      (Pi.single (6 : Fin 144) (1 : ℤ) +
        Pi.single (9 : Fin 144) (1 : ℤ) +
        Pi.single (38 : Fin 144) (1 : ℤ) +
...
private def tropicalComponentBFactorEdge044Monomial028 :
    MonomialReductionCertificate tropicalComponentBCharacter8
...
private def tropicalComponentBFactorEdge044Monomial038 :
    MonomialReductionCertificate tropicalComponentBCharacter8
      (Pi.single (0 : Fin 144) (1 : ℤ) +
        Pi.single (15 : Fin 144) (1 : ℤ) +
        Pi.single (38 : Fin 144) (1 : ℤ) +
...
private def tropicalComponentBFactorEdge044Use8 :
...
![
  { coefficient := (1 : ℤ)
      ...
      targetExponent := (Pi.single (6 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (89 : Fin 144) (1 : ℤ) +
        Pi.single (139 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentBFactorEdge044Monomial008 },
  { coefficient := (-1 : ℤ)
      sourceExponent := (Pi.single (6 : Fin 144) (1 : ℤ) +
        Pi.single (9 : Fin 144) (1 : ℤ) +
        Pi.single (38 : Fin 144) (1 : ℤ) +
      ...
      targetExponent := (Pi.single (6 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (89 : Fin 144) (1 : ℤ) +
        Pi.single (142 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentBFactorEdge044Monomial018 },
  { coefficient := (-1 : ℤ)
      ...
      targetExponent := (Pi.single (0 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (89 : Fin 144) (1 : ℤ) +
        Pi.single (139 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentBFactorEdge044Monomial028 },
  { coefficient := (1 : ℤ)
      sourceExponent := (Pi.single (0 : Fin 144) (1 : ℤ) +
        Pi.single (15 : Fin 144) (1 : ℤ) +
        Pi.single (38 : Fin 144) (1 : ℤ) +
      ...
      targetExponent := (Pi.single (0 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (89 : Fin 144) (1 : ℤ) +
        Pi.single (142 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentBFactorEdge044Monomial038 }
]

private theorem tropicalComponentBFactorEdge044_source_eq :
    (∑ k : Fin 4,
      Finsupp.single (tropicalComponentBFactorEdge044Use8 k).sourceExponent
        (tropicalComponentBFactorEdge044Use8 k).coefficient) =
      tropicalComponentBQuotientRelation8 53 := by
  decide

private theorem tropicalComponentBFactorEdge044_target_eq :
    (∑ k : Fin 4,
      Finsupp.single (tropicalComponentBFactorEdge044Use8 k).targetExponent
        (signedCoefficient (tropicalComponentBFactorEdge044Use8 k).reduction.signExponent
          (tropicalComponentBFactorEdge044Use8 k).coefficient)) =
      (1 : ℤ) • LaurentPolynomial.translate (Pi.single (6 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (49 : Fin 144) (1 : ℤ) +
        Pi.single (89 : Fin 144) (1 : ℤ) +
        Pi.single (139 : Fin 144) (1 : ℤ)) ((tropicalComponentBRawFactor8 12).factorProductPolynomial (tropicalComponentBRawFactor8 44)) := by
  decide

/-- Exact Laurent factor certificate for raw edge 44. -/
def tropicalComponentBFactorCertificate8_044 :
  ...
  shift := (Pi.single (6 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (139 : Fin 144) (1 : ℤ))
  reduction := {
    use := tropicalComponentBFactorEdge044Use8
    source_eq := tropicalComponentBFactorEdge044_source_eq
    target_eq := tropicalComponentBFactorEdge044_target_eq
  }
...
theorem tropicalComponentBRawFactorEdgeProduct8_044
  ...
  factorValues_mul_eq_zero_of_certificate
    ...
    tropicalComponentBFactorCertificate8_044 hChars
    (tropicalComponentBQuotientRelations8_hold hSupport hEq hChars 53)
