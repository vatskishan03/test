import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E010.Certificate
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q046.Hold

/-!
# Factor edge 10 hold from exactly quotient row 46
-/
...
/-- Row-local product vanishing for raw factor edge 10. -/
theorem product
  ...
  factorValues_mul_eq_zero_of_certificate
    ...
    (by
      simpa [sourceRelation] using
        TropicalFactorB8.Internal.Quotient046.hold
          hSupport hEq hChars)
