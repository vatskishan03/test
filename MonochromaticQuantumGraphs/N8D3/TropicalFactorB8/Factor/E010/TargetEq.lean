import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E010.Uses

/-!
# Factor edge 10 sparse translated-product equality
-/
...
/-- Sparse translated-product equality for factor edge 10. -/
theorem target_eq :
    (∑ k : Fin 4,
