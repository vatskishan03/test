import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E003.Uses

/-!
# Factor edge 3 sparse translated-product equality
-/
...
/-- Sparse translated-product equality for factor edge 3. -/
theorem target_eq :
    (∑ k : Fin 4,
