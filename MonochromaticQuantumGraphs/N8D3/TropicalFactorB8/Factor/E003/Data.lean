...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.Vertex.V040

/-!
# Row-local data for Component-B factor edge 3
-/
...
def sourceRelation : LaurentPolynomial (Fin 144) :=
  TropicalFactorB8.Internal.Quotient064.relation
...
def rightFactor : SignedCharacterRow (Fin 144) :=
  TropicalFactorB8.Internal.Vertex040.row
