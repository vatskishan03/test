import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E017.Uses

/-!
# Factor edge 17 sparse translated-product equality
-/
...
/-- Sparse translated-product equality for factor edge 17. -/
theorem target_eq :
    (∑ k : Fin 4,
