...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.Vertex.V002
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.Vertex.V007

/-!
# Row-local data for Component-B factor edge 17
-/
...
def sourceRelation : LaurentPolynomial (Fin 144) :=
  TropicalFactorB8.Internal.Quotient050.relation
...
def rightFactor : SignedCharacterRow (Fin 144) :=
  TropicalFactorB8.Internal.Vertex007.row
