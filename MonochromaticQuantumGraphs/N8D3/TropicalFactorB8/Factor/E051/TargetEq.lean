import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E051.Uses

/-!
# Factor edge 51 sparse translated-product equality
-/
...
/-- Sparse translated-product equality for factor edge 51. -/
theorem target_eq :
    (∑ k : Fin 4,
