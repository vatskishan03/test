import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E007.Uses

/-!
# Factor edge 7 sparse translated-product equality
-/
...
/-- Sparse translated-product equality for factor edge 7. -/
theorem target_eq :
    (∑ k : Fin 4,
