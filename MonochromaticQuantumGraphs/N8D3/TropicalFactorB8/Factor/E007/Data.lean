...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q055.Data
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.Vertex.V000
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.Vertex.V046

/-!
# Row-local data for Component-B factor edge 7
-/
...
def sourceRelation : LaurentPolynomial (Fin 144) :=
  TropicalFactorB8.Internal.Quotient055.relation
...
def rightFactor : SignedCharacterRow (Fin 144) :=
  TropicalFactorB8.Internal.Vertex046.row
