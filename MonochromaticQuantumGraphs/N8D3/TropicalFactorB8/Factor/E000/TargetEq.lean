import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E000.Uses

/-!
# Factor edge 0 sparse translated-product equality
-/
...
/-- Sparse translated-product equality for factor edge 0. -/
theorem target_eq :
    (∑ k : Fin 4,
