...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.Vertex.V038

/-!
# Row-local data for Component-B factor edge 41
-/
...
def sourceRelation : LaurentPolynomial (Fin 144) :=
  TropicalFactorB8.Internal.Quotient037.relation
...
def rightFactor : SignedCharacterRow (Fin 144) :=
  TropicalFactorB8.Internal.Vertex038.row
