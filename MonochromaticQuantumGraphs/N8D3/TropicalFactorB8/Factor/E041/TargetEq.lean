import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E041.Uses

/-!
# Factor edge 41 sparse translated-product equality
-/
...
/-- Sparse translated-product equality for factor edge 41. -/
theorem target_eq :
    (∑ k : Fin 4,
