import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E039.Uses

/-!
# Factor edge 39 sparse translated-product equality
-/
...
/-- Sparse translated-product equality for factor edge 39. -/
theorem target_eq :
    (∑ k : Fin 4,
