...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.Vertex.V036

/-!
# Row-local data for Component-B factor edge 39
-/
...
def sourceRelation : LaurentPolynomial (Fin 144) :=
  TropicalFactorB8.Internal.Quotient035.relation
...
def rightFactor : SignedCharacterRow (Fin 144) :=
  TropicalFactorB8.Internal.Vertex036.row
