...
/-!
# Component-B raw factor edge 12
...
private def tropicalComponentBFactorEdge012Monomial008 :
...
private def tropicalComponentBFactorEdge012Monomial018 :
    MonomialReductionCertificate tropicalComponentBCharacter8
      (Pi.single (6 : Fin 144) (-1 : ℤ) +
        Pi.single (7 : Fin 144) (1 : ℤ) +
        Pi.single (26 : Fin 144) (1 : ℤ) +
...
private def tropicalComponentBFactorEdge012Monomial028 :
    MonomialReductionCertificate tropicalComponentBCharacter8
      (Pi.single (26 : Fin 144) (1 : ℤ) +
...
private def tropicalComponentBFactorEdge012Monomial038 :
    MonomialReductionCertificate tropicalComponentBCharacter8
      (Pi.single (26 : Fin 144) (1 : ℤ) +
        Pi.single (51 : Fin 144) (1 : ℤ) +
        Pi.single (69 : Fin 144) (1 : ℤ) +
...
private def tropicalComponentBFactorEdge012Use8 :
...
![
  { coefficient := (1 : ℤ)
      ...
      targetExponent := (Pi.single (6 : Fin 144) (-1 : ℤ) +
        ...
        Pi.single (89 : Fin 144) (1 : ℤ) +
        Pi.single (117 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentBFactorEdge012Monomial008 },
  { coefficient := (-1 : ℤ)
      sourceExponent := (Pi.single (6 : Fin 144) (-1 : ℤ) +
        Pi.single (7 : Fin 144) (1 : ℤ) +
        Pi.single (26 : Fin 144) (1 : ℤ) +
      ...
      targetExponent := (Pi.single (6 : Fin 144) (-1 : ℤ) +
        ...
        Pi.single (88 : Fin 144) (1 : ℤ) +
        Pi.single (120 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentBFactorEdge012Monomial018 },
  { coefficient := (-1 : ℤ)
      ...
      targetExponent := (Pi.single (26 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (89 : Fin 144) (1 : ℤ) +
        Pi.single (117 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentBFactorEdge012Monomial028 },
  { coefficient := (1 : ℤ)
      sourceExponent := (Pi.single (26 : Fin 144) (1 : ℤ) +
        Pi.single (51 : Fin 144) (1 : ℤ) +
        Pi.single (69 : Fin 144) (1 : ℤ) +
      ...
      targetExponent := (Pi.single (26 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (88 : Fin 144) (1 : ℤ) +
        Pi.single (120 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentBFactorEdge012Monomial038 }
]

private theorem tropicalComponentBFactorEdge012_source_eq :
    (∑ k : Fin 4,
      Finsupp.single (tropicalComponentBFactorEdge012Use8 k).sourceExponent
        (tropicalComponentBFactorEdge012Use8 k).coefficient) =
      tropicalComponentBQuotientRelation8 45 := by
  decide

private theorem tropicalComponentBFactorEdge012_target_eq :
    (∑ k : Fin 4,
      Finsupp.single (tropicalComponentBFactorEdge012Use8 k).targetExponent
        (signedCoefficient (tropicalComponentBFactorEdge012Use8 k).reduction.signExponent
          (tropicalComponentBFactorEdge012Use8 k).coefficient)) =
      (1 : ℤ) • LaurentPolynomial.translate (Pi.single (6 : Fin 144) (-1 : ℤ) +
        ...
        Pi.single (69 : Fin 144) (1 : ℤ) +
        Pi.single (89 : Fin 144) (1 : ℤ) +
        Pi.single (117 : Fin 144) (1 : ℤ)) ((tropicalComponentBRawFactor8 1).factorProductPolynomial (tropicalComponentBRawFactor8 27)) := by
  decide

/-- Exact Laurent factor certificate for raw edge 12. -/
def tropicalComponentBFactorCertificate8_012 :
    LaurentFactorCertificate (κ := Fin 4) tropicalComponentBCharacter8
      ...
      (tropicalComponentBRawFactor8 27) where
  unit := (1 : ℤ)
  ...
  shift := (Pi.single (6 : Fin 144) (-1 : ℤ) +
        ...
        Pi.single (117 : Fin 144) (1 : ℤ))
  reduction := {
    use := tropicalComponentBFactorEdge012Use8
    source_eq := tropicalComponentBFactorEdge012_source_eq
    target_eq := tropicalComponentBFactorEdge012_target_eq
  }
...
theorem tropicalComponentBRawFactorEdgeProduct8_012
  ...
  factorValues_mul_eq_zero_of_certificate
    ...
    (tropicalComponentBQuotientRelation8 45)
    (tropicalComponentBRawFactor8 1)
    (tropicalComponentBRawFactor8 27)
    tropicalComponentBFactorCertificate8_012 hChars
    (tropicalComponentBQuotientRelations8_hold hSupport hEq hChars 45)
