import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E040.Uses

/-!
# Factor edge 40 sparse translated-product equality
-/
...
/-- Sparse translated-product equality for factor edge 40. -/
theorem target_eq :
    (∑ k : Fin 4,
