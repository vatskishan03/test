...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.Vertex.V020
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.Vertex.V039

/-!
# Row-local data for Component-B factor edge 58
-/
...
def leftFactor : SignedCharacterRow (Fin 144) :=
  TropicalFactorB8.Internal.Vertex020.row
