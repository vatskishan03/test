import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E046.Uses

/-!
# Factor edge 46 sparse translated-product equality
-/
...
/-- Sparse translated-product equality for factor edge 46. -/
theorem target_eq :
    (∑ k : Fin 4,
