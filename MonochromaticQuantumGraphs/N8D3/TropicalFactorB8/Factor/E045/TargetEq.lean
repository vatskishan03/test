import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E045.Uses

/-!
# Factor edge 45 sparse translated-product equality
-/
...
/-- Sparse translated-product equality for factor edge 45. -/
theorem target_eq :
    (∑ k : Fin 4,
