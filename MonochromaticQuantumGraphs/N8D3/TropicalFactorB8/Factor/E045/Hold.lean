import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E045.Certificate
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q066.Hold

/-!
# Factor edge 45 hold from exactly quotient row 66
-/
...
/-- Row-local product vanishing for raw factor edge 45. -/
theorem product
  ...
  factorValues_mul_eq_zero_of_certificate
    ...
    (by
      simpa [sourceRelation] using
        TropicalFactorB8.Internal.Quotient066.hold
          hSupport hEq hChars)
