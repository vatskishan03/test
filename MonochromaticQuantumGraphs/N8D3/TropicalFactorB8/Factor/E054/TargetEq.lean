import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E054.Uses

/-!
# Factor edge 54 sparse translated-product equality
-/
...
/-- Sparse translated-product equality for factor edge 54. -/
theorem target_eq :
    (∑ k : Fin 4,
