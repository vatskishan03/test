...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.Vertex.V034

/-!
# Row-local data for Component-B factor edge 26
-/
...
def rightFactor : SignedCharacterRow (Fin 144) :=
  TropicalFactorB8.Internal.Vertex034.row
