import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E043.Uses

/-!
# Factor edge 43 sparse translated-product equality
-/
...
/-- Sparse translated-product equality for factor edge 43. -/
theorem target_eq :
    (∑ k : Fin 4,
