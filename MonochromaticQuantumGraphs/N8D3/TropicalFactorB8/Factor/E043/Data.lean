...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.Vertex.V033

/-!
# Row-local data for Component-B factor edge 43
-/
...
def sourceRelation : LaurentPolynomial (Fin 144) :=
  TropicalFactorB8.Internal.Quotient030.relation
...
def rightFactor : SignedCharacterRow (Fin 144) :=
  TropicalFactorB8.Internal.Vertex033.row
