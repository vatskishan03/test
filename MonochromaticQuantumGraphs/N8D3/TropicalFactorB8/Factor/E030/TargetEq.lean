import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E030.Uses

/-!
# Factor edge 30 sparse translated-product equality
-/
...
/-- Sparse translated-product equality for factor edge 30. -/
theorem target_eq :
    (∑ k : Fin 4,
