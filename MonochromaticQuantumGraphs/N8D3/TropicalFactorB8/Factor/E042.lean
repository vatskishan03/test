...
/-!
# Component-B raw factor edge 42
...
private def tropicalComponentBFactorEdge042Monomial008 :
...
private def tropicalComponentBFactorEdge042Monomial018 :
    MonomialReductionCertificate tropicalComponentBCharacter8
      (Pi.single (7 : Fin 144) (1 : ℤ) +
        Pi.single (9 : Fin 144) (1 : ℤ) +
        Pi.single (41 : Fin 144) (1 : ℤ) +
...
private def tropicalComponentBFactorEdge042Monomial028 :
    MonomialReductionCertificate tropicalComponentBCharacter8
...
private def tropicalComponentBFactorEdge042Monomial038 :
    MonomialReductionCertificate tropicalComponentBCharacter8
      (Pi.single (1 : Fin 144) (1 : ℤ) +
        Pi.single (15 : Fin 144) (1 : ℤ) +
        Pi.single (41 : Fin 144) (1 : ℤ) +
...
private def tropicalComponentBFactorEdge042Use8 :
...
![
  { coefficient := (1 : ℤ)
      ...
      targetExponent := (Pi.single (7 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (86 : Fin 144) (1 : ℤ) +
        Pi.single (138 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentBFactorEdge042Monomial008 },
  { coefficient := (-1 : ℤ)
      sourceExponent := (Pi.single (7 : Fin 144) (1 : ℤ) +
        Pi.single (9 : Fin 144) (1 : ℤ) +
        Pi.single (41 : Fin 144) (1 : ℤ) +
      ...
      targetExponent := (Pi.single (7 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (86 : Fin 144) (1 : ℤ) +
        Pi.single (141 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentBFactorEdge042Monomial018 },
  { coefficient := (-1 : ℤ)
      ...
      targetExponent := (Pi.single (1 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (86 : Fin 144) (1 : ℤ) +
        Pi.single (138 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentBFactorEdge042Monomial028 },
  { coefficient := (1 : ℤ)
      sourceExponent := (Pi.single (1 : Fin 144) (1 : ℤ) +
        Pi.single (15 : Fin 144) (1 : ℤ) +
        Pi.single (41 : Fin 144) (1 : ℤ) +
      ...
      targetExponent := (Pi.single (1 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (86 : Fin 144) (1 : ℤ) +
        Pi.single (141 : Fin 144) (1 : ℤ))
      reduction := tropicalComponentBFactorEdge042Monomial038 }
]

private theorem tropicalComponentBFactorEdge042_source_eq :
    (∑ k : Fin 4,
      Finsupp.single (tropicalComponentBFactorEdge042Use8 k).sourceExponent
        (tropicalComponentBFactorEdge042Use8 k).coefficient) =
      tropicalComponentBQuotientRelation8 25 := by
  decide

private theorem tropicalComponentBFactorEdge042_target_eq :
    (∑ k : Fin 4,
      Finsupp.single (tropicalComponentBFactorEdge042Use8 k).targetExponent
        (signedCoefficient (tropicalComponentBFactorEdge042Use8 k).reduction.signExponent
          (tropicalComponentBFactorEdge042Use8 k).coefficient)) =
      (1 : ℤ) • LaurentPolynomial.translate (Pi.single (7 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (52 : Fin 144) (1 : ℤ) +
        Pi.single (86 : Fin 144) (1 : ℤ) +
        Pi.single (138 : Fin 144) (1 : ℤ)) ((tropicalComponentBRawFactor8 11).factorProductPolynomial (tropicalComponentBRawFactor8 32)) := by
  decide

/-- Exact Laurent factor certificate for raw edge 42. -/
def tropicalComponentBFactorCertificate8_042 :
    LaurentFactorCertificate (κ := Fin 4) tropicalComponentBCharacter8
      ...
      (tropicalComponentBRawFactor8 32) where
  unit := (1 : ℤ)
  ...
  shift := (Pi.single (7 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (138 : Fin 144) (1 : ℤ))
  reduction := {
    use := tropicalComponentBFactorEdge042Use8
    source_eq := tropicalComponentBFactorEdge042_source_eq
    target_eq := tropicalComponentBFactorEdge042_target_eq
  }
...
theorem tropicalComponentBRawFactorEdgeProduct8_042
  ...
  factorValues_mul_eq_zero_of_certificate
    ...
    (tropicalComponentBQuotientRelation8 25)
    (tropicalComponentBRawFactor8 11)
    (tropicalComponentBRawFactor8 32)
    tropicalComponentBFactorCertificate8_042 hChars
    (tropicalComponentBQuotientRelations8_hold hSupport hEq hChars 25)
