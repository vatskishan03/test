import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E034.Uses

/-!
# Factor edge 34 sparse translated-product equality
-/
...
/-- Sparse translated-product equality for factor edge 34. -/
theorem target_eq :
    (∑ k : Fin 4,
