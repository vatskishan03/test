import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E034.Certificate
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q036.Hold

/-!
# Factor edge 34 hold from exactly quotient row 36
-/
...
/-- Row-local product vanishing for raw factor edge 34. -/
theorem product
  ...
  factorValues_mul_eq_zero_of_certificate
    ...
    (by
      simpa [sourceRelation] using
        TropicalFactorB8.Internal.Quotient036.hold
          hSupport hEq hChars)
