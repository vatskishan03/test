...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.Vertex.V025

/-!
# Row-local data for Component-B factor edge 36
-/
...
def rightFactor : SignedCharacterRow (Fin 144) :=
  TropicalFactorB8.Internal.Vertex025.row
