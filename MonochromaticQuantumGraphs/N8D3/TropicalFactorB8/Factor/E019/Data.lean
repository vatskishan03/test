...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q049.Data
...
/-!
# Row-local data for Component-B factor edge 19
-/
...
def sourceRelation : LaurentPolynomial (Fin 144) :=
  TropicalFactorB8.Internal.Quotient049.relation
