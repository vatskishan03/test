import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E019.Uses

/-!
# Factor edge 19 sparse source equality
-/
...
/-- Sparse source equality for factor edge 19. -/
theorem source_eq :
    (∑ k : Fin 4,
