import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E024.Uses

/-!
# Factor edge 24 sparse source equality
-/
...
/-- Sparse source equality for factor edge 24. -/
theorem source_eq :
    (∑ k : Fin 4,
  ...
  simp [uses, monomial00,
    ...
    TropicalFactorB8.Internal.Quotient029.relation,
