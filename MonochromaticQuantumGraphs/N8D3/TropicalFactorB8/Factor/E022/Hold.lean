import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E022.Certificate
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q081.Hold

/-!
# Factor edge 22 hold from exactly quotient row 81
-/
...
/-- Row-local product vanishing for raw factor edge 22. -/
theorem product
  ...
  factorValues_mul_eq_zero_of_certificate
    ...
    (by
      simpa [sourceRelation] using
        TropicalFactorB8.Internal.Quotient081.hold
          hSupport hEq hChars)
