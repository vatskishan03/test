import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E038.Uses

/-!
# Factor edge 38 sparse translated-product equality
-/
...
/-- Sparse translated-product equality for factor edge 38. -/
theorem target_eq :
    (∑ k : Fin 4,
