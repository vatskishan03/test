...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.Vertex.V035

/-!
# Row-local data for Component-B factor edge 38
-/
...
def sourceRelation : LaurentPolynomial (Fin 144) :=
  TropicalFactorB8.Internal.Quotient031.relation
...
def rightFactor : SignedCharacterRow (Fin 144) :=
  TropicalFactorB8.Internal.Vertex035.row
