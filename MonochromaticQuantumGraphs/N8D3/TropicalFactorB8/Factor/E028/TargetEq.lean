import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E028.Uses

/-!
# Factor edge 28 sparse translated-product equality
-/
...
/-- Sparse translated-product equality for factor edge 28. -/
theorem target_eq :
    (∑ k : Fin 4,
