import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E048.Certificate
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q052.Hold

/-!
# Factor edge 48 hold from exactly quotient row 52
-/
...
/-- Row-local product vanishing for raw factor edge 48. -/
theorem product
  ...
  factorValues_mul_eq_zero_of_certificate
    ...
    (by
      simpa [sourceRelation] using
        TropicalFactorB8.Internal.Quotient052.hold
          hSupport hEq hChars)
