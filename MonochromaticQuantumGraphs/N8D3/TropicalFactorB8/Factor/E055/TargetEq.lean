import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E055.Uses

/-!
# Factor edge 55 sparse translated-product equality
-/
...
/-- Sparse translated-product equality for factor edge 55. -/
theorem target_eq :
    (∑ k : Fin 4,
