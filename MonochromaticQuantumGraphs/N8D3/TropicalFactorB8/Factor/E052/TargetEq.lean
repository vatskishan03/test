import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E052.Uses

/-!
# Factor edge 52 sparse translated-product equality
-/
...
/-- Sparse translated-product equality for factor edge 52. -/
theorem target_eq :
    (∑ k : Fin 4,
