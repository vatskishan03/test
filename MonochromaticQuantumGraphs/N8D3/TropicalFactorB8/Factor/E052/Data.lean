...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.Vertex.V016
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.Vertex.V027

/-!
# Row-local data for Component-B factor edge 52
-/
...
def sourceRelation : LaurentPolynomial (Fin 144) :=
  TropicalFactorB8.Internal.Quotient069.relation

/-- Left raw factor endpoint. -/
def leftFactor : SignedCharacterRow (Fin 144) :=
  TropicalFactorB8.Internal.Vertex016.row
