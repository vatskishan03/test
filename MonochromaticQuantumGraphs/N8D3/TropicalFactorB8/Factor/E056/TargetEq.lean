import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E056.Uses

/-!
# Factor edge 56 sparse translated-product equality
-/
...
/-- Sparse translated-product equality for factor edge 56. -/
theorem target_eq :
    (∑ k : Fin 4,
