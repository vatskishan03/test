...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.Vertex.V018
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.Vertex.V042

/-!
# Row-local data for Component-B factor edge 56
-/
...
def sourceRelation : LaurentPolynomial (Fin 144) :=
  TropicalFactorB8.Internal.Quotient085.relation

/-- Left raw factor endpoint. -/
def leftFactor : SignedCharacterRow (Fin 144) :=
  TropicalFactorB8.Internal.Vertex018.row
