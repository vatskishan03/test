import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E002.Certificate
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q058.Hold

/-!
# Factor edge 2 hold from exactly quotient row 58
-/
...
/-- Row-local product vanishing for raw factor edge 2. -/
theorem product
  ...
  factorValues_mul_eq_zero_of_certificate
    ...
    (by
      simpa [sourceRelation] using
        TropicalFactorB8.Internal.Quotient058.hold
          hSupport hEq hChars)
