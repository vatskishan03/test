import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E002.Uses

/-!
# Factor edge 2 sparse translated-product equality
-/
...
/-- Sparse translated-product equality for factor edge 2. -/
theorem target_eq :
    (∑ k : Fin 4,
