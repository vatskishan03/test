...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.Vertex.V021

/-!
# Row-local data for Component-B factor edge 32
-/
...
def rightFactor : SignedCharacterRow (Fin 144) :=
  TropicalFactorB8.Internal.Vertex021.row
