import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E025.Uses

/-!
# Factor edge 25 sparse translated-product equality
-/
...
/-- Sparse translated-product equality for factor edge 25. -/
theorem target_eq :
    (∑ k : Fin 4,
