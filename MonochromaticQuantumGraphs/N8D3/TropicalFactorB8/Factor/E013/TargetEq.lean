import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E013.Uses

/-!
# Factor edge 13 sparse translated-product equality
-/
...
/-- Sparse translated-product equality for factor edge 13. -/
theorem target_eq :
    (∑ k : Fin 4,
