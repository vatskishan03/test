...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q047.Data
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.Vertex.V001
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.Vertex.V028

/-!
# Row-local data for Component-B factor edge 13
-/
...
def sourceRelation : LaurentPolynomial (Fin 144) :=
  TropicalFactorB8.Internal.Quotient047.relation
...
def rightFactor : SignedCharacterRow (Fin 144) :=
  TropicalFactorB8.Internal.Vertex028.row
