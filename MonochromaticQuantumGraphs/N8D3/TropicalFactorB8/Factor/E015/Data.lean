...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.Vertex.V030

/-!
# Row-local data for Component-B factor edge 15
-/
...
def sourceRelation : LaurentPolynomial (Fin 144) :=
  TropicalFactorB8.Internal.Quotient079.relation
