import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E023.Uses

/-!
# Factor edge 23 sparse source equality
-/
...
/-- Sparse source equality for factor edge 23. -/
theorem source_eq :
    (∑ k : Fin 4,
