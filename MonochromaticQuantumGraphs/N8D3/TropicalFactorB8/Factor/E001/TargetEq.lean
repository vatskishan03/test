import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E001.Uses

/-!
# Factor edge 1 sparse translated-product equality
-/
...
/-- Sparse translated-product equality for factor edge 1. -/
theorem target_eq :
    (∑ k : Fin 4,
