import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E004.Uses

/-!
# Factor edge 4 sparse translated-product equality
-/
...
/-- Sparse translated-product equality for factor edge 4. -/
theorem target_eq :
    (∑ k : Fin 4,
