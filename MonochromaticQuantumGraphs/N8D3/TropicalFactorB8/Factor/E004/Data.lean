...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.Vertex.V041

/-!
# Row-local data for Component-B factor edge 4
-/
...
def sourceRelation : LaurentPolynomial (Fin 144) :=
  TropicalFactorB8.Internal.Quotient077.relation
...
def rightFactor : SignedCharacterRow (Fin 144) :=
  TropicalFactorB8.Internal.Vertex041.row
