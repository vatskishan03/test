import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Factor.E018.Uses

/-!
# Factor edge 18 sparse source equality
-/
...
/-- Sparse source equality for factor edge 18. -/
theorem source_eq :
    (∑ k : Fin 4,
