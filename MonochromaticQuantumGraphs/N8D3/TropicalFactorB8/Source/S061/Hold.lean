import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Source.S061.Certificate
import MonochromaticQuantumGraphs.N8D3.TropicalRetainedRelations8

/-!
# Source 61 semantic hold (the only retained aggregate import)
-/
...
theorem hold
  ...
  have hi := tropicalBaseRelations8_hold hSupport hEq
    tropicalOverlapProvenance8Row62.sourceI
  have hj := tropicalBaseRelations8_hold hSupport hEq
    tropicalOverlapProvenance8Row62.sourceJ
  have hsource : sourcePolynomial.Holds (tropicalSupportWeight8 W) := by
    rw [sourcePolynomial, tropicalOverlapRelation8_provenance_row62]
  ...
  exact holds_of_normalizedCharacterReductionCertificate
    ...
    tropicalComponentBSourceReductionCertificate8_061
    hChars hsource
