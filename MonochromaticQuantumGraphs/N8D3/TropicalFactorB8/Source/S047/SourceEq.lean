...
/-!
# Source 47 sparse source equality
-/
...
/-- Sparse source-polynomial equality for source reduction 47. -/
theorem source_eq :
    (∑ k : Fin 6,
  ...
  simp [uses, use00,
    ...
    tropicalBaseRelation8, Fin.sum_univ_succ, tropicalOverlapRelation8Row18] <;> abel
