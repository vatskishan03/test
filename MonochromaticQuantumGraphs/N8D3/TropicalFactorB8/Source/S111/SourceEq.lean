...
/-!
# Source 111 sparse source equality
-/
...
/-- Sparse source-polynomial equality for source reduction 111. -/
theorem source_eq :
    (∑ k : Fin 6,
  ...
  simp [uses, monomial00,
    ...
    tropicalBaseRelation8, Fin.sum_univ_succ, tropicalOverlapRelation8Row265] <;> abel
