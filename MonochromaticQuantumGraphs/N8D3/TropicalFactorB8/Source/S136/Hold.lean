import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Source.S136.Certificate
import MonochromaticQuantumGraphs.N8D3.TropicalRetainedRelations8

/-!
# Source 136 semantic hold (the only retained aggregate import)
-/
...
theorem hold
  ...
  have hi := tropicalBaseRelations8_hold hSupport hEq
    tropicalOverlapProvenance8Row319.sourceI
  have hj := tropicalBaseRelations8_hold hSupport hEq
    tropicalOverlapProvenance8Row319.sourceJ
  have hsource : sourcePolynomial.Holds (tropicalSupportWeight8 W) := by
    rw [sourcePolynomial, tropicalOverlapRelation8_provenance_row319]
  ...
  exact holds_of_normalizedCharacterReductionCertificate
    ...
    tropicalComponentBSourceReductionCertificate8_136
    hChars hsource
