import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Source.S027.Uses
import MonochromaticQuantumGraphs.N8D3.TropicalRetainedRelations8.Data

/-!
# Source 27 sparse source equality
-/
...
/-- Sparse source-polynomial equality for source reduction 27. -/
theorem source_eq :
    (∑ k : Fin 6,
      Finsupp.single (uses k).sourceExponent (uses k).coefficient) =
      sourcePolynomial := by
  have hcolor : tropicalBaseColoring8 127 =
