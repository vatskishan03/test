import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Source.S033.Certificate
import MonochromaticQuantumGraphs.N8D3.TropicalRetainedRelations8

/-!
# Source 33 semantic hold (the only retained aggregate import)
-/
...
theorem hold
  ...
  have hsource := tropicalBaseRelations8_hold hSupport hEq (133 : Fin 200)
  exact holds_of_normalizedCharacterReductionCertificate
    (tropicalSupportWeight8 W) (tropicalSupportWeight8_ne_zero hSupport)
    tropicalComponentBCharacter8 sourcePolynomial reduced
    tropicalComponentBSourceReductionCertificate8_033
    hChars hsource
