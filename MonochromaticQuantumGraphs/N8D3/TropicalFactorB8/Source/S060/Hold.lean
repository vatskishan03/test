import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Source.S060.Certificate
import MonochromaticQuantumGraphs.N8D3.TropicalRetainedRelations8

/-!
# Source 60 semantic hold (the only retained aggregate import)
-/
...
theorem hold
  ...
  have hi := tropicalBaseRelations8_hold hSupport hEq
    tropicalOverlapProvenance8Row59.sourceI
  have hj := tropicalBaseRelations8_hold hSupport hEq
    tropicalOverlapProvenance8Row59.sourceJ
  have hsource : sourcePolynomial.Holds (tropicalSupportWeight8 W) := by
    rw [sourcePolynomial, tropicalOverlapRelation8_provenance_row59]
  ...
  exact holds_of_normalizedCharacterReductionCertificate
    ...
    tropicalComponentBSourceReductionCertificate8_060
    hChars hsource
