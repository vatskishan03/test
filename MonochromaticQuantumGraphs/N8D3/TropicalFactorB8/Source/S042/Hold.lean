import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Source.S042.Certificate
import MonochromaticQuantumGraphs.N8D3.TropicalRetainedRelations8

/-!
# Source 42 semantic hold (the only retained aggregate import)
-/
...
theorem hold
  ...
  have hi := tropicalBaseRelations8_hold hSupport hEq
    tropicalOverlapProvenance8Row4.sourceI
  have hj := tropicalBaseRelations8_hold hSupport hEq
    tropicalOverlapProvenance8Row4.sourceJ
  have hsource : sourcePolynomial.Holds (tropicalSupportWeight8 W) := by
    rw [sourcePolynomial, tropicalOverlapRelation8_provenance_row4]
  ...
  exact holds_of_normalizedCharacterReductionCertificate
    ...
    tropicalComponentBSourceReductionCertificate8_042
    hChars hsource
