import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Source.S055.Certificate
import MonochromaticQuantumGraphs.N8D3.TropicalRetainedRelations8

/-!
# Source 55 semantic hold (the only retained aggregate import)
-/
...
theorem hold
  ...
  have hi := tropicalBaseRelations8_hold hSupport hEq
    tropicalOverlapProvenance8Row42.sourceI
  have hj := tropicalBaseRelations8_hold hSupport hEq
    tropicalOverlapProvenance8Row42.sourceJ
  have hsource : sourcePolynomial.Holds (tropicalSupportWeight8 W) := by
    rw [sourcePolynomial, tropicalOverlapRelation8_provenance_row42]
  ...
  exact holds_of_normalizedCharacterReductionCertificate
    ...
    tropicalComponentBSourceReductionCertificate8_055
    hChars hsource
