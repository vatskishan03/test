import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q035.Data

/-!
# Quotient 35 sparse shifted-combination equality
-/
...
theorem shifted_eq :
  ...
  have hexp1_5 :
    ...
    ext x
    simp [Pi.single_apply] <;> split_ifs <;> omega
  simp [shiftedUse, shiftedSources, TropicalFactorB8.Internal.Source058.reduced,
    TropicalFactorB8.Internal.Source069.reduced, intermediate,
