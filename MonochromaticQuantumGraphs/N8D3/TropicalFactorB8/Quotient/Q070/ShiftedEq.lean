import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q070.Data

/-!
# Quotient 70 sparse shifted-combination equality
-/
...
theorem shifted_eq :
  ...
  have hexp1_5 :
      ...
      (Pi.single (6 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (139 : Fin 144) (1 : ℤ))) := by
    ext x; simp [Pi.single_apply]; split_ifs <;> omega
  simp [shiftedUse, shiftedSources, TropicalFactorB8.Internal.Source114.reduced,
    TropicalFactorB8.Internal.Source117.reduced, intermediate,
