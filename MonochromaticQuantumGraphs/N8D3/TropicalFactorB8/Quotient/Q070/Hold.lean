import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q070.Certificate
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Source.S114.Hold
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Source.S117.Hold

/-!
# Quotient 70 local hold from exactly two source rows
-/
...
/-- Row-local semantic hold for quotient relation 70. -/
theorem hold
  ...
  have hsources : ∀ s : Fin 2,
    ...
    · simpa [shiftedSources] using
        TropicalFactorB8.Internal.Source117.hold hSupport hEq hChars
  have hintermediate :
