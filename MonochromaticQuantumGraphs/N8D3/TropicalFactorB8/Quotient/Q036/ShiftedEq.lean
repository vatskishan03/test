...
/-!
# Quotient 36 sparse shifted-combination equality
-/
...
theorem shifted_eq :
  ...
  have hexp1_5 :
    ...
    ext x
    simp [Pi.single_apply] <;> split_ifs <;> omega
  simp [shiftedUse, shiftedSources, TropicalFactorB8.Internal.Source059.reduced,
    TropicalFactorB8.Internal.Source070.reduced, intermediate,
