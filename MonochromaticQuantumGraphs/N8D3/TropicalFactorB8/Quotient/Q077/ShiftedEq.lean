import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q077.Data

/-!
# Quotient 77 sparse shifted-combination equality
-/
...
theorem shifted_eq :
  ...
  have hexp1_5 :
      ...
      (Pi.single (1 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (139 : Fin 144) (1 : ℤ))) := by
    ext x; simp [Pi.single_apply]; split_ifs <;> omega
  simp [shiftedUse, shiftedSources, TropicalFactorB8.Internal.Source122.reduced,
    TropicalFactorB8.Internal.Source125.reduced, intermediate,
