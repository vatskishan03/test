import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q000.Data

/-!
# Quotient 0 sparse shifted-combination equality
-/
...
theorem shifted_eq :
  ...
  have hexp1_5 :
      ...
      (Pi.single (6 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (139 : Fin 144) (1 : ℤ)) := by
    abel
  simp [shiftedUse, shiftedSources, TropicalFactorB8.Internal.Source000.reduced,
    TropicalFactorB8.Internal.Source020.reduced, intermediate,
