...
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Source.S060.Data
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Source.S071.Data

/-!
# Row-local data for Component-B quotient 37
-/
...
![
  TropicalFactorB8.Internal.Source060.reduced,
  TropicalFactorB8.Internal.Source071.reduced
]
...
def intermediate : LaurentPolynomial (Fin 144) :=
  (Finsupp.single (Pi.single (11 : Fin 144) (1 : ℤ) +
