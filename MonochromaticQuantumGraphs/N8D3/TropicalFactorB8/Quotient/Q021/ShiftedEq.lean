import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q021.Data

/-!
# Quotient 21 sparse shifted-combination equality
-/
...
theorem shifted_eq :
  ...
  have hexp1_5 :
      ...
      (Pi.single (7 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (138 : Fin 144) (1 : ℤ))) := by
    ext x; simp [Pi.single_apply]; split_ifs <;> omega
  simp [shiftedUse, shiftedSources, TropicalFactorB8.Internal.Source041.reduced,
    TropicalFactorB8.Internal.Source043.reduced, intermediate,
