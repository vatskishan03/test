import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q030.Data

/-!
# Quotient 30 sparse shifted-combination equality
-/
...
theorem shifted_eq :
  ...
  have hexp1_5 :
      ...
      (Pi.single (1 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (141 : Fin 144) (1 : ℤ))) := by
    ext x; simp [Pi.single_apply]; split_ifs <;> omega
  simp [shiftedUse, shiftedSources, TropicalFactorB8.Internal.Source049.reduced,
    TropicalFactorB8.Internal.Source080.reduced, intermediate,
