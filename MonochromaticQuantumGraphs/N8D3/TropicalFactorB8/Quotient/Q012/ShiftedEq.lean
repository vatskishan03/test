import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q012.Data

/-!
# Quotient 12 sparse shifted-combination equality
-/
...
theorem shifted_eq :
  ...
  have hexp1_5 :
    ...
    ext x
    simp [Pi.single_apply] <;> split_ifs <;> omega
  simp [shiftedUse, shiftedSources, TropicalFactorB8.Internal.Source012.reduced,
    TropicalFactorB8.Internal.Source032.reduced, intermediate,
