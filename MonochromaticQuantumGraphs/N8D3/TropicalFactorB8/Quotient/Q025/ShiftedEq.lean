...
/-!
# Quotient 25 sparse shifted-combination equality
-/
...
theorem shifted_eq :
  ...
  have hexp1_2 :
      (((0 : LaurentExponent (Fin 144)) +
        ...
        Pi.single (41 : Fin 144) (1 : ℤ) +
        Pi.single (86 : Fin 144) (1 : ℤ) +
        Pi.single (141 : Fin 144) (1 : ℤ)) : LaurentExponent (Fin 144)) =
      (Pi.single (7 : Fin 144) (1 : ℤ) +
        Pi.single (9 : Fin 144) (1 : ℤ) +
        Pi.single (41 : Fin 144) (1 : ℤ) +
        Pi.single (86 : Fin 144) (1 : ℤ) +
  ...
  simp [shiftedUse, shiftedSources, TropicalFactorB8.Internal.Source047.reduced,
    TropicalFactorB8.Internal.Source079.reduced, intermediate,
