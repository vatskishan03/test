import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q027.Data

/-!
# Quotient 27 sparse shifted-combination equality
-/
...
theorem shifted_eq :
  ...
  have hexp0_1 :
      (((Pi.single (86 : Fin 144) (-1 : ℤ) +
        ...
        Pi.single (51 : Fin 144) (1 : ℤ) +
        Pi.single (86 : Fin 144) (1 : ℤ) +
        Pi.single (126 : Fin 144) (1 : ℤ)) : LaurentExponent (Fin 144)) =
      (Pi.single (7 : Fin 144) (1 : ℤ) +
        Pi.single (9 : Fin 144) (1 : ℤ) +
        Pi.single (51 : Fin 144) (1 : ℤ) +
        Pi.single (87 : Fin 144) (1 : ℤ) +
  ...
  have hexp1_0 :
      (((0 : LaurentExponent (Fin 144)) +
        ...
        Pi.single (51 : Fin 144) (1 : ℤ) +
        Pi.single (69 : Fin 144) (1 : ℤ) +
        Pi.single (122 : Fin 144) (1 : ℤ)) : LaurentExponent (Fin 144)) =
      (Pi.single (7 : Fin 144) (1 : ℤ) +
        Pi.single (19 : Fin 144) (1 : ℤ) +
        Pi.single (51 : Fin 144) (1 : ℤ) +
        Pi.single (69 : Fin 144) (1 : ℤ) +
  ...
  have hexp1_5 :
    ...
    ext x
    simp [Pi.single_apply] <;> split_ifs <;> omega
  simp [shiftedUse, shiftedSources, TropicalFactorB8.Internal.Source047.reduced,
    TropicalFactorB8.Internal.Source056.reduced, intermediate,
