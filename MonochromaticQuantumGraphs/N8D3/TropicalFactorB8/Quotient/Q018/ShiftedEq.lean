import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q018.Data

/-!
# Quotient 18 sparse shifted-combination equality
-/
...
theorem shifted_eq :
  ...
  have hexp1_5 :
      ...
      (Pi.single (1 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (139 : Fin 144) (1 : ℤ)) := by
    abel
  simp [shiftedUse, shiftedSources, TropicalFactorB8.Internal.Source018.reduced,
    TropicalFactorB8.Internal.Source038.reduced, intermediate,
