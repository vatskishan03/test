import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q042.Data

/-!
# Quotient 42 sparse shifted-combination equality
-/
...
theorem shifted_eq :
  ...
  have hexp1_5 :
      ...
      (Pi.single (6 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (139 : Fin 144) (1 : ℤ)) := by
    abel
  simp [shiftedUse, shiftedSources, TropicalFactorB8.Internal.Source081.reduced,
    TropicalFactorB8.Internal.Source104.reduced, intermediate,
