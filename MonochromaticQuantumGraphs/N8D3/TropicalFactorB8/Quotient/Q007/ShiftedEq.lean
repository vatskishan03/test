import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q007.Data

/-!
# Quotient 7 sparse shifted-combination equality
-/
...
theorem shifted_eq :
  ...
  have hexp1_5 :
    ...
    ext x
    simp [Pi.single_apply] <;> split_ifs <;> omega
  simp [shiftedUse, shiftedSources, TropicalFactorB8.Internal.Source007.reduced,
    TropicalFactorB8.Internal.Source027.reduced, intermediate,
