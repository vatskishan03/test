import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q039.Data

/-!
# Quotient 39 sparse shifted-combination equality
-/
...
theorem shifted_eq :
  ...
  have hexp0_0 :
      (((Pi.single (58 : Fin 144) (-1 : ℤ) +
        ...
        Pi.single (116 : Fin 144) (1 : ℤ)) : LaurentExponent (Fin 144)) =
      (Pi.single (25 : Fin 144) (1 : ℤ) +
        Pi.single (51 : Fin 144) (1 : ℤ) +
        Pi.single (58 : Fin 144) (-1 : ℤ) +
        Pi.single (64 : Fin 144) (1 : ℤ) +
  ...
  have hexp0_1 :
      (((Pi.single (58 : Fin 144) (-1 : ℤ) +
        ...
        Pi.single (119 : Fin 144) (1 : ℤ)) : LaurentExponent (Fin 144)) =
      (Pi.single (25 : Fin 144) (1 : ℤ) +
        Pi.single (51 : Fin 144) (1 : ℤ) +
        Pi.single (58 : Fin 144) (-1 : ℤ) +
        Pi.single (64 : Fin 144) (1 : ℤ) +
  ...
  have hexp0_2 :
      (((Pi.single (58 : Fin 144) (-1 : ℤ) +
        ...
        Pi.single (132 : Fin 144) (1 : ℤ)) : LaurentExponent (Fin 144)) =
      (Pi.single (7 : Fin 144) (1 : ℤ) +
        Pi.single (64 : Fin 144) (1 : ℤ) +
        Pi.single (86 : Fin 144) (1 : ℤ) +
        Pi.single (108 : Fin 144) (1 : ℤ) +
  ...
  have hexp0_3 :
      (((Pi.single (58 : Fin 144) (-1 : ℤ) +
        ...
        Pi.single (138 : Fin 144) (1 : ℤ)) : LaurentExponent (Fin 144)) =
      (Pi.single (7 : Fin 144) (1 : ℤ) +
        Pi.single (64 : Fin 144) (1 : ℤ) +
        Pi.single (86 : Fin 144) (1 : ℤ) +
        Pi.single (100 : Fin 144) (1 : ℤ) +
  ...
  have hexp1_5 :
      ...
      (Pi.single (7 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (138 : Fin 144) (1 : ℤ))) := by
    ext x; simp [Pi.single_apply]; split_ifs <;> omega
  simp [shiftedUse, shiftedSources, TropicalFactorB8.Internal.Source073.reduced,
    TropicalFactorB8.Internal.Source075.reduced, intermediate,
