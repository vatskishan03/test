import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q006.Data

/-!
# Quotient 6 sparse shifted-combination equality
-/
...
theorem shifted_eq :
  ...
  have hexp1_5 :
      ...
      (Pi.single (1 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (139 : Fin 144) (1 : ℤ))) := by
    ext x; simp [Pi.single_apply]; split_ifs <;> omega
  simp [shiftedUse, shiftedSources, TropicalFactorB8.Internal.Source006.reduced,
    TropicalFactorB8.Internal.Source026.reduced, intermediate,
