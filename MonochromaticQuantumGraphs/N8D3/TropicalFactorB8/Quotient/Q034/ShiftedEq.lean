import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q034.Data

/-!
# Quotient 34 sparse shifted-combination equality
-/
...
theorem shifted_eq :
  ...
  have hexp1_5 :
    ...
    ext x
    simp [Pi.single_apply] <;> split_ifs <;> omega
  simp [shiftedUse, shiftedSources, TropicalFactorB8.Internal.Source055.reduced,
    TropicalFactorB8.Internal.Source068.reduced, intermediate,
