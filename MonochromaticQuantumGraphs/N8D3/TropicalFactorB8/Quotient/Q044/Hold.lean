import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q044.Certificate
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Source.S082.Hold
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Source.S105.Hold

/-!
# Quotient 44 local hold from exactly two source rows
-/
...
/-- Row-local semantic hold for quotient relation 44. -/
theorem hold
  ...
  have hsources : ∀ s : Fin 2,
    ...
    · simpa [shiftedSources] using
        TropicalFactorB8.Internal.Source105.hold hSupport hEq hChars
  have hintermediate :
