import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q016.Data

/-!
# Quotient 16 sparse shifted-combination equality
-/
...
theorem shifted_eq :
  ...
  have hexp1_5 :
      ...
      (Pi.single (0 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (139 : Fin 144) (1 : ℤ)) := by
    abel
  simp [shiftedUse, shiftedSources, TropicalFactorB8.Internal.Source016.reduced,
    TropicalFactorB8.Internal.Source036.reduced, intermediate,
