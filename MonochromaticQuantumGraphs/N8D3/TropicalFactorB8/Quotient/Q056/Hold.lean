import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q056.Certificate
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Source.S092.Hold
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Source.S108.Hold

/-!
# Quotient 56 local hold from exactly two source rows
-/
...
/-- Row-local semantic hold for quotient relation 56. -/
theorem hold
  ...
  have hsources : ∀ s : Fin 2,
    ...
    · simpa [shiftedSources] using
        TropicalFactorB8.Internal.Source108.hold hSupport hEq hChars
  have hintermediate :
      intermediate.Holds (tropicalSupportWeight8 W) :=
    LaurentPolynomial.holds_of_shiftedCombinationCertificate
      (tropicalSupportWeight8 W) (tropicalSupportWeight8_ne_zero hSupport)
      shiftedSources intermediate
      tropicalComponentBQuotientShiftedCertificate8_056
      hsources
  exact holds_of_normalizedCharacterReductionCertificate
    (tropicalSupportWeight8 W) (tropicalSupportWeight8_ne_zero hSupport)
    tropicalComponentBCharacter8 intermediate relation
    tropicalComponentBQuotientReductionCertificate8_056
