import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q058.Certificate
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Source.S092.Hold
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Source.S101.Hold

/-!
# Quotient 58 local hold from exactly two source rows
-/
...
/-- Row-local semantic hold for quotient relation 58. -/
theorem hold
  ...
  have hsources : ∀ s : Fin 2,
    ...
    · simpa [shiftedSources] using
        TropicalFactorB8.Internal.Source101.hold hSupport hEq hChars
  have hintermediate :
      intermediate.Holds (tropicalSupportWeight8 W) :=
    LaurentPolynomial.holds_of_shiftedCombinationCertificate
      (tropicalSupportWeight8 W) (tropicalSupportWeight8_ne_zero hSupport)
      shiftedSources intermediate
      tropicalComponentBQuotientShiftedCertificate8_058
      hsources
  exact holds_of_normalizedCharacterReductionCertificate
    (tropicalSupportWeight8 W) (tropicalSupportWeight8_ne_zero hSupport)
    tropicalComponentBCharacter8 intermediate relation
    tropicalComponentBQuotientReductionCertificate8_058
