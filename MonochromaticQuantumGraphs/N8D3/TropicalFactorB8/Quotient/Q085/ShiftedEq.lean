import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q085.Data

/-!
# Quotient 85 sparse shifted-combination equality
-/
...
theorem shifted_eq :
  ...
  have hexp0_0 :
      (((Pi.single (9 : Fin 144) (-1 : ℤ) +
        ...
        Pi.single (120 : Fin 144) (1 : ℤ)) : LaurentExponent (Fin 144)) =
      (Pi.single (1 : Fin 144) (1 : ℤ) +
        Pi.single (9 : Fin 144) (-1 : ℤ) +
        Pi.single (11 : Fin 144) (1 : ℤ) +
        Pi.single (20 : Fin 144) (1 : ℤ) +
  ...
  have hexp0_2 :
      (((Pi.single (9 : Fin 144) (-1 : ℤ) +
        ...
        Pi.single (89 : Fin 144) (1 : ℤ) +
        Pi.single (142 : Fin 144) (1 : ℤ)) : LaurentExponent (Fin 144)) =
      (Pi.single (1 : Fin 144) (1 : ℤ) +
        Pi.single (11 : Fin 144) (1 : ℤ) +
        Pi.single (38 : Fin 144) (1 : ℤ) +
        Pi.single (90 : Fin 144) (1 : ℤ) +
  ...
  have hexp1_5 :
    ...
    ext x
    simp [Pi.single_apply] <;> split_ifs <;> omega
  simp [shiftedUse, shiftedSources, TropicalFactorB8.Internal.Source136.reduced,
    TropicalFactorB8.Internal.Source144.reduced, intermediate,
