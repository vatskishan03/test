import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q078.Data

/-!
# Quotient 78 sparse shifted-combination equality
-/
...
theorem shifted_eq :
  ...
  have hexp1_5 :
      ...
      (Pi.single (6 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (142 : Fin 144) (1 : ℤ))) := by
    ext x; simp [Pi.single_apply]; split_ifs <;> omega
  simp [shiftedUse, shiftedSources, TropicalFactorB8.Internal.Source127.reduced,
    TropicalFactorB8.Internal.Source132.reduced, intermediate,
