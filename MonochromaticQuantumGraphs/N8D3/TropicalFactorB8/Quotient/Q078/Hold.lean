import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q078.Certificate
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Source.S127.Hold
import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Source.S132.Hold

/-!
# Quotient 78 local hold from exactly two source rows
-/
...
/-- Row-local semantic hold for quotient relation 78. -/
theorem hold
  ...
  have hsources : ∀ s : Fin 2,
    ...
    · simpa [shiftedSources] using
        TropicalFactorB8.Internal.Source127.hold hSupport hEq hChars
    · simpa [shiftedSources] using
        TropicalFactorB8.Internal.Source132.hold hSupport hEq hChars
  have hintermediate :
