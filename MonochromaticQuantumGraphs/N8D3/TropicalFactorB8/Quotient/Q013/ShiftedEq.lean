import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q013.Data

/-!
# Quotient 13 sparse shifted-combination equality
-/
...
theorem shifted_eq :
  ...
  have hexp1_5 :
      ...
      (Pi.single (6 : Fin 144) (1 : ℤ) +
        ...
        Pi.single (139 : Fin 144) (1 : ℤ))) := by
    ext x; simp [Pi.single_apply]; split_ifs <;> omega
  simp [shiftedUse, shiftedSources, TropicalFactorB8.Internal.Source013.reduced,
    TropicalFactorB8.Internal.Source033.reduced, intermediate,
