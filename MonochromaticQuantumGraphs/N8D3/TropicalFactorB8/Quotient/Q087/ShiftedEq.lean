import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q087.Data

/-!
# Quotient 87 sparse shifted-combination equality
-/
...
theorem shifted_eq :
  ...
  have hexp1_5 :
    ...
    ext x
    simp [Pi.single_apply] <;> split_ifs <;> omega
  simp [shiftedUse, shiftedSources, TropicalFactorB8.Internal.Source138.reduced,
    TropicalFactorB8.Internal.Source141.reduced, intermediate,
