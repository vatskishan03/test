import MonochromaticQuantumGraphs.N8D3.TropicalFactorB8.Quotient.Q005.Data

/-!
# Quotient 5 sparse shifted-combination equality
-/
...
theorem shifted_eq :
  ...
  have hexp1_5 :
    ...
    ext x
    simp [Pi.single_apply] <;> split_ifs <;> omega
  simp [shiftedUse, shiftedSources, TropicalFactorB8.Internal.Source005.reduced,
    TropicalFactorB8.Internal.Source025.reduced, intermediate,
