...
- Seventy-one superseded Lean files were retired: sixty old exact-support amplitude wrappers, their premise assembly, eight root-unreachable compatibility/experimental modules, the unused matching-block helper, and a diagnostic-only smoke test. Nine superseded Candidate129 discovery scripts were also retired. All remain recoverable from the pre-cleanup archive.
